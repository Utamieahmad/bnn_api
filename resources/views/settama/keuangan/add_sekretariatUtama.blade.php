...
@section('title', 'Tambah Kegiatan Biro Keuangan Sekretariat Utama')
    ...
    <div class="right_col" role="main">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Form Tambah Kegiatan Biro Keuangan Sekretariat Utama</h2>
                            <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <br />
                        ...
                        @endif
                        <form  method="POST" action="{{route('save_settama_keuangan')}}" id="multipart-form" data-parsley-validate class="form-horizontal" enctype="multipart/form-data" onSubmit="validateForm(event,this)">
                        {{csrf_field()}}
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select name="pelaksana" class="form-control select2" required>
                                            ...
                                            <option value="2" data-target="2"> Biro Keuangan </option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="form-actions fluid m-t-20">
                                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                    ...
                                    <a href="{{route('settama_keuangan')}}" class="btn btn-primary" type="button">BATAL</a>
                                </div>
                            </div>
                        </form>
                    </div>
