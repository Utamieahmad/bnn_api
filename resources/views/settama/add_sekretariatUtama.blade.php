    ...
    <div class="right_col" role="main">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Form Tambah Kegiatan Sekretariat Utama</h2>
                            <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <br />
                        ...
                        @endif
                        <form  method="POST" action="{{route('save_sekretariat_utama')}}" id="multipart-form" data-parsley-validate class="form-horizontal" enctype="multipart/form-data" onSubmit="validateForm(event,this)">
                        {{csrf_field()}}
                            <div class="form-body">
                                                ...
                                                @if(count($rujukan))
                                                    @foreach($rujukan as $rkey => $rval )
                                                        <div class="group">
                                                            ...
                                                            <div class="mt-radio col-md-12 col-sm-12 col-xs-12 m-l-10 m-b-10 hide nomor">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select name="pelaksana" class="form-control select2" onChange="getBagianPelaksana(this)">
                                            <option value="">-- Pilih Pelaksana--</option>
                                            @if(isset($pelaksana))
                                                @if(count($pelaksana))
                                                    @foreach($pelaksana as $pkey => $pval )
                                                       <option value="{{trim($pval->id_settama_lookup)}}" data-target="{{ trim($pval->id_settama_lookup)}}"> {{trim($pval->lookup_name)}} </option>
                                                    @endforeach
                                                @endif
                                            @endif
                                        </select>
