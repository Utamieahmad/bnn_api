...
@section('title', 'Tambah Kegiatan Biro Perencanaan Sekretariat Utama')
    ...
    <div class="right_col" role="main">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Form Tambah Kegiatan Biro Perencanaan Sekretariat Utama</h2>
                            <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <br />
                        ...
                        @endif
                        <form  method="POST" action="{{route('save_settama_perencanaan')}}" id="multipart-form" data-parsley-validate class="form-horizontal" enctype="multipart/form-data" onSubmit="validateForm(event,this)">
                        {{csrf_field()}}
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select name="pelaksana" class="form-control select2" required>
                                            ...
                                            <option value="4" data-target="4"> Biro Perencanaan </option>
                                        </select>
                                    </div>
                                </div>
