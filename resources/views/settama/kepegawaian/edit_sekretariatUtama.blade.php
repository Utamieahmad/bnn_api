...
@section('title', 'Ubah Kegiatan Biro Kepegawaian dan Organisasi Sekretariat Utama')
    ...
    <div class="right_col edit_settama" role="main">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Form Ubah Kegiatan Biro Kepegawaian dan Organisasi Sekretariat Utama</h2>
                            <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <br />
                        ...
                        @endif
                        <form  method="POST" action="{{route('update_settama_kepegawaian')}}" data-parsley-validate class="form-horizontal " enctype="multipart/form-data" id="multipart-form" onSubmit="validateForm(event,this)">
                        {{csrf_field()}}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select name="pelaksana" class="form-control select2 list_pelaksana" required>
                                            ...
                                            <option value="3" data-target="3" selected="selected"> Biro Kepegawaian dan Organisasi </option>
                                        </select>
                                    </div>
                                </div>
