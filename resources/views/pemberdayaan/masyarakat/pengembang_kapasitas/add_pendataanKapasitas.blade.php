...
@section('title', 'Dir Peran Serta Masyarakat : Tambah Data Kegiatan Pengembangan Kapasitas')
...
@section('content')
    <div class="right_col" role="main">
        ...
        <div class="row">
            ...
            <div class="x_panel">
                <div class="x_title">
                    <h2>Form Tambah Data Kegiatan Pengembangan Kapasitas Direktorat Peran Serta Masyarakat</h2>
                    <div class="clearfix"></div>
                </div>
    <div class="x_content">
                    <br />
    <form action="{{URL('/pemberdayaan/dir_masyarakat/input_pendataan_kapasitas')}}" class="form-horizontal" id="frm_add" method="post" enctype="multipart/form-data" autocomplete="on" files="true">
