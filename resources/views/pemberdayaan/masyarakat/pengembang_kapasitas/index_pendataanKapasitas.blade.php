...
@section('title', 'Dir Peran Serta Masyarakat : Data Kegiatan Pengembangan Kapasitas')
		...
		<div class="m-t-40">
			...
			<div class="row">
				...
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="x_panel">
						<div class="x_title">
							<h2>Data Kegiatan Pengembangan Kapasitas<small></small></h2>
							...
							<li class="">
							<a href="{{url('pemberdayaan/dir_masyarakat/add_pendataan_kapasitas')}}" class="btn btn-lg btn-round btn-primary">
						...
						<div class="x_content ">
								...
								<tbody>
									...
									@foreach($data_kapasitas as $d)
										<tr>
											...
											<td>
												<a href="{{url('pemberdayaan/dir_masyarakat/edit_pendataan_kapasitas/'.$d['id'])}}"><i class="fa fa-pencil"></i></a>
							...
							@else
								<div class="alert alert-warning">
									Data Pengembangan Kapasitas belum tersedia.
								</div>
							@endif
