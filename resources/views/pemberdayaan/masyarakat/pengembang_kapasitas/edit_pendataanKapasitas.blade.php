...
@section('title', 'Dir Peran Serta Masyarakat : Ubah Data Kegiatan Pengembangan Kapasitas')
...
@section('content')
    <div class="right_col" role="main">
        ...
        <div class="row">
            ...
            <div class="x_panel">
                <div class="x_title">
                    <h2>Form Ubah Data Kegiatan Pengembangan Kapasitas Direktorat Peran Serta Masyarakat</h2>
                    <div class="clearfix"></div>
                </div>
    <div class="x_content">
                    <br />
    <form action="{{URL('/pemberdayaan/dir_masyarakat/update_pendataan_kapasitas')}}" class="form-horizontal" id="frm_add" method="post" enctype="multipart/form-data" autocomplete="on">
            ...
            <div class="col-md-5">
                ...
                <span class="help-block" style="color:white">
                    @if (!empty($data_detail['data']['file_upload']))
                        lihat file : <a style="color:yellow" href="{{\Storage::url('PsmPengembanganKapasitas/'.$data_detail['data']['file_upload'])}}">{{$data_detail['data']['file_upload']}}</a>
                    @endif
                </span>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                <button type="submit" class="btn btn-success">KIRIM</button>
								<a href="{{route('pendataan_kapasitas')}}" class="btn btn-primary" type="button">BATAL</a>
            </div>
        </div>
    </div>
</form>
