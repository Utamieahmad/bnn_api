					...
					<div class="x_panel">
						<div class="x_title">
							...
							<ul class="nav navbar-right panel_toolbox">
								<li class="" @php if(!in_array(72, Session::get("cancreate")))  echo 'style="display:none;"'; @endphp>
									<a href="#" class="btn btn-lg btn-round btn-danger" data-toggle="modal" data-target="#modal_input_nihil">
										<i class="fa fa-plus-circle"></i> Input Nihil
									</a>
								</li>
								<li class="" @php if(!in_array(72, Session::get("cancreate")))  echo 'style="display:none;"'; @endphp>
									<a href="{{route('add_rapat_kerja_pemetaan')}}" class="btn btn-lg btn-round btn-primary">
										<i class="fa fa-plus-circle c-yelow"></i> Tambah Data
									</a>
								</li>
								<li class="">
									<a href="{{route('print_page_dayamas',['rapat_kerja_pemetaan',$kondisi])}}" class="btn btn-lg btn-round btn-dark">
								...
								@if(count($data))
									...
									@foreach($data as $k=>$d)
										<tr>
											...
											<td>
												<a @php if(!in_array(72, Session::get("canedit")))  echo 'style="display:none;"'; @endphp href="{{route('edit_rapat_kerja_pemetaan',$d->id)}}"><i class="fa fa-pencil"></i></a>
				                              	<button @php if(!in_array(72, Session::get("candelete")))  echo 'style="display:none;"'; @endphp type="button" class="btn btn-primary button-delete-form" data-target="{{$d->id}}" onClick="delete_form(event,this)"><i class="fa fa-trash"></i></button>
				                            </td>
										</tr>
										@php
											$i = $i+1;
