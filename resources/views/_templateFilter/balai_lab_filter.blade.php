    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-6 col-xs-12">
        ...
        ?>
          ...
          <div class="col-md-6 col-sm-6 col-xs-12 keyword {{(isset($filter['tipe']) ? ((($filter['tipe'] == 'no_lab' ) || ($filter['tipe'] == 'no_surat_permohonan') || ($filter['tipe'] == 'no_lap') || ($filter['tipe'] == 'nama_instansi') || ($filter['tipe'] == 'posisi_berkas') || ($filter['tipe'] == 'jenis_berkas') || ($filter['tipe'] == 'status_berkas') )  ? '' : 'hide') :'')}} div-wrap">
        ...
        <div class="clearfix"></div>
          <div class="row tanggal_terima {{(isset($filter['tipe']) ? (($filter['tipe'] == 'tanggal_terima') ? '' : 'hide') :'hide')}} div-wrap">
