      ...
      <div class="col-md-6 col-sm-6 col-xs-12">
        ...
        ?>
          ...
          <div class="col-md-6 col-sm-6 col-xs-12 keyword {{(isset($filter['tipe']) ? (($filter['tipe'] == 'lokasi') ? '' : 'hide') :'')}} div-wrap">
            ...
            <input class="form-control" name="kata_kunci" value="{{isset($filter) ? (isset($filter['lokasi'])?$filter['lokasi']:'') :''}}" {{isset($filter['lokasi']) ? ($filter['lokasi'] ? '':'disabled=disabled') :'disabled=disabled'}}  />
          </div>
