    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-6 col-xs-12">
        ...
        ?>
          ...
          <div class="col-md-6 col-sm-6 col-xs-12 keyword {{(isset($filter['tipe']) ? (( ($filter['tipe'] == 'periode')|| ($filter['tipe'] == 'tahun_anggaran')|| ($filter['tipe'] == 'status') ) ? 'hide' : '') :'')}} div-wrap">
        ...
        <div class="clearfix"></div>
        <div class="tahun_anggaran {{(isset($filter['tipe']) ? (($filter['tipe'] == 'tahun_anggaran') ? '' : 'hide') :'hide')}} div-wrap row">
            <div class="col-md-6 col-sm-6 col-xs-12 m-t-10">
