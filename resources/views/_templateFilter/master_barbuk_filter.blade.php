        ...
        ?>
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <select class="form-control select2"  name="tipe" onchange="formFilter(this)">
              ...
              <option value="nama" {{(isset($filter['tipe']) ? (($filter['tipe'] == 'nama') ? 'selected=selected' : '') :'')}}>Nama Barang Bukti</option>
              <option value="satuan" {{(isset($filter['tipe']) ? (($filter['tipe'] == 'satuan') ? 'selected=selected' : '') :'')}}>Satuan</option>
              <option value="jenis" {{(isset($filter['tipe']) ? (($filter['tipe'] == 'jenis') ? 'selected=selected' : '') :'')}}>Jenis Barang Bukti</option>
              <option value="kasus" {{(isset($filter['tipe']) ? (($filter['tipe'] == 'kasus') ? 'selected=selected' : '') :'')}}>Jenis Kasus</option>
            </select>
          </div>
