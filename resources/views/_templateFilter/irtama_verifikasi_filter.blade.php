      ...
      <div class="col-md-6 col-sm-6 col-xs-12">
        ...
        <?php
          $key = [
            ...
            'status' => 'Status',
            // 'pejabat_diganti' => 'Pejabat yang Diganti',
            // 'pejabat_baru' => 'Pejabat yang Baru',
          ];
          $f = $filter;
        ?>
          ...
          <div class="col-md-6 col-sm-6 col-xs-12 keyword {{(isset($filter['tipe']) ? ((($filter['tipe'] == 'sprin' ) || ($filter['tipe'] == 'pejabat_diganti') || ($filter['tipe'] == 'pejabat_baru') )  ? '' : 'hide') :'')}} div-wrap">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12 kode_satker {{(isset($filter['tipe']) ? (($filter['tipe'] == 'kode_satker') ? '' : 'hide') :'hide')}} div-wrap">
            ...
            <select class="form-control select2" name="kode_satker" onchange="console.log($(this).find(':selected').text())">
