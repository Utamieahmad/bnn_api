    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-6 col-xs-12">
        ...
        ?>
          ...
          <div class="col-md-6 col-sm-6 col-xs-12 keyword {{(isset($filter['tipe']) ? ((($filter['tipe'] == 'nomor_sprint_dpo' ) || ($filter['tipe'] == 'no_identitas') || ($filter['tipe'] == 'alamat') )  ? '' : 'hide') :'')}} div-wrap">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12 kode_jenis_kelamin {{(isset($filter['tipe']) ? ((($filter['tipe'] == 'kode_jenis_kelamin' )  )  ? '' : 'hide') :'hide')}} div-wrap">
              <label for="tipe" class="control-label">Tipe</label>

              <select class="form-control select2"  name="kode_jenis_kelamin">
                <option>-- Pilih Jenis Kelamin -- </option>
                <option value="L" {{isset($filter) ? ( isset($filter['kode_jenis_kelamin'])? ($filter['kode_jenis_kelamin'] == 'L' ? 'selected=selected':''): '' ): ''}}> Laki-Laki</option>
                <option value="P" {{isset($filter) ? ( isset($filter['kode_jenis_kelamin'])? ($filter['kode_jenis_kelamin'] == 'P' ? 'selected=selected':''): '' ): ''}}> Perempuan</option>
    ...
    <div class="m-b-20">
      ...
      @endphp
        ...
        @if( isset($s['tipe']))
          ...
          @elseif($s['tipe'] == 'kode_jenis_kelamin')
            {{( isset($s['kode_jenis_kelamin'])  ?( ($s['kode_jenis_kelamin'] == 'P' ) ? 'Perempuan' .' ,' : 'Laki-Laki'.' ,') :  '' )}}
          @else
