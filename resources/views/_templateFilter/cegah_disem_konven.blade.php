        ...
        ?>
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <select class="form-control select2"  name="tipe" onchange="formFilter(this)">
              ...
              <option value="sasaran" {{(isset($filter['tipe']) ? (($filter['tipe'] == 'sasaran') ? 'selected=selected' : '') :'')}}>Sasaran</option>
          ...
          <div class="col-md-6 col-sm-6 col-xs-12 sasaran {{isset($filter['tipe']) ? ( $filter['tipe'] == 'sasaran' ? '':'hide'): 'hide'}} div-wrap" >
              ...
              <select class="form-control select2" name="sasaran">
                <option value="LINGKUNGAN_MASYARAKAT" {{isset($filter)? (isset($filter['sasaran']) ? ($filter['sasaran'] == 'LINGKUNGAN_MASYARAKAT' ? 'selected=selected' : '') :''):''}} >Masyarakat</option>
                <option value="LINGKUNGAN_KELUARGA" {{isset($filter)? (isset($filter['sasaran']) ? ($filter['sasaran'] == 'LINGKUNGAN_KELUARGA' ? 'selected=selected' : '') :''):''}} >Keluarga</option>
                <option value="LINGKUNGAN_MAHASISWA" {{isset($filter)? (isset($filter['sasaran']) ? ($filter['sasaran'] == 'LINGKUNGAN_MAHASISWA' ? 'selected=selected' : '') :''):''}} >Mahasiswa</option>
                <option value="LINGKUNGAN_PEKERJA" {{isset($filter)? (isset($filter['sasaran']) ? ($filter['sasaran'] == 'LINGKUNGAN_PEKERJA' ? 'selected=selected' : '') :''):''}} >Pekerja</option>
                <option value="LINGKUNGAN_PELAJAR"  {{isset($filter)? (isset($filter['sasaran']) ? ($filter['sasaran'] == 'LINGKUNGAN_PELAJAR' ? 'selected=selected' : '') :''):''}} >Pelajar</option>
              </select>
          </div>
