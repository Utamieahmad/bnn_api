        ...
        ?>
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <select class="form-control select2"  name="tipe" onchange="formFilter(this)">
              ...
              <option value="instansi" {{(isset($filter['tipe']) ? (($filter['tipe'] == 'instansi') ? 'selected=selected' : '') :'')}}>Nama Instansi</option>
              <option value="wilayah" {{(isset($filter['tipe']) ? (($filter['tipe'] == 'wilayah') ? 'selected=selected' : '') :'')}}>Wilayah</option>
              <option value="alamat" {{(isset($filter['tipe']) ? (($filter['tipe'] == 'alamat') ? 'selected=selected' : '') :'')}}>Alamat</option>
            </select>
          </div>
