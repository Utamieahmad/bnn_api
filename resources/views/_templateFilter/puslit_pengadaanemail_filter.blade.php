    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-6 col-xs-12">
        ...
        ?>
          ...
          <div class="col-md-6 col-sm-6 col-xs-12 keyword {{( isset($filter['tipe']) ?  ( ($filter['tipe'] == 'email')   ? '' : 'hide')  :'' )}} div-wrap">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12 jns_kuota {{(isset($filter['tipe']) ? (($filter['tipe'] == 'jns_kuota') ? '' : 'hide') :'hide')}} div-wrap">
            <label for="tipe" class="control-label"> Status</label>
             <select class="form-control select2 " name="jns_kuota">
                <option>-- Pilih Status --</option>
                <option value="unlimited" {{(isset($filter['jns_kuota']) ? (($filter['jns_kuota'] == 'unlimited') ? 'selected=selected' : '') :'')}}>Unlimited</option>
                <option value="limited" {{(isset($filter['jns_kuota']) ? (($filter['jns_kuota'] == 'limited') ? 'selected=selected' : '') :'')}}>Limited</option>
