        ...
        ?>
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <select class="form-control select2"  name="tipe" onchange="formFilter(this)">
              <option value="nama" {{(isset($filter['tipe']) ? (($filter['tipe'] == 'nama') ? 'selected=selected' : '') :'')}}>Nama Jenis Kasus</option>
            </select>
          </div>
          <div class="col-md-6 col-sm-6 col-xs-12 keyword div-wrap">
            <label for="tipe" class="control-label">Kata Kunci</label>
            <input class="form-control" name="kata_kunci" value="{{isset($filter) ? (isset($filter['kata_kunci'])?$filter['kata_kunci']:'') :''}}"  />
          </div>
        </div>
