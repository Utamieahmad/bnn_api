    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-6 col-xs-12">
        ...
        ?>
          ...
          <div class="col-md-6 col-sm-6 col-xs-12 keyword {{( isset($filter['tipe']) ?  ( (($filter['tipe'] == 'tim') || ($filter['tipe'] == 'aktivitas'))  ? '' : 'hide')  :'' )}} div-wrap">
            <label for="tipe" class="control-label">Kata Kunci</label>
            <?php
              $kata_kunci = "";
              $tipe_keyword = ['tim','aktivitas'];
          ...
          <div class="col-md-6 col-sm-6 col-xs-12 satker {{(isset($filter['tipe']) ? (($filter['tipe'] == 'satker') ? '' : 'hide') :'hide')}} div-wrap">
            <label for="tipe" class="control-label"> Satuan Kerja</label>
