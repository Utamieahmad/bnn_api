  ...
  <form class="form-group filter" action="{{isset($route) ? route($route) : ''}}" method="post">
    <div class="row">
      ...
      <div class="col-md-6 col-sm-6 col-xs-12">
        ...
        <?php
          $key = [
            'nama' => 'Nama Media Online',
            'kode' => 'Kode Media Online',
          ];
        ?>
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <select class="form-control select2"  name="tipe" onchange="formFilter(this)">
              ...
              <option value="nama" {{(isset($filter['tipe']) ? (($filter['tipe'] == 'nama') ? 'selected=selected' : '') :'')}}>Nama Media Online</option>
              <option value="kode" {{(isset($filter['tipe']) ? (($filter['tipe'] == 'kode') ? 'selected=selected' : '') :'')}}>Kode Media Online</option>
            </select>
          </div>
