        ...
        ?>
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <select class="form-control select2"  name="tipe" onchange="formFilter(this)">
              ...
              <option value="nama" {{(isset($filter['tipe']) ? (($filter['tipe'] == 'nama') ? 'selected=selected' : '') :'')}}>Nama Kegiatan</option>
              <option value="biro" {{(isset($filter['tipe']) ? (($filter['tipe'] == 'biro') ? 'selected=selected' : '') :'')}}>Biro</option>
            </select>
          </div>
