        ...
        ?>
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <select class="form-control select2"  name="tipe" onchange="formFilter(this)">
              ...
              <option value="media" {{(isset($filter['tipe']) ? (($filter['tipe'] == 'media') ? 'selected=selected' : '') :'')}}>Nama Media</option>
              <option value="jenis" {{(isset($filter['tipe']) ? (($filter['tipe'] == 'jenis') ? 'selected=selected' : '') :'')}}>Jenis Media</option>
          ...
          <div class="col-md-6 col-sm-6 col-xs-12 keyword {{(isset($filter['tipe']) ? ((($filter['tipe'] == 'pelaksana') || ($filter['tipe'] == 'periode') || ($filter['tipe'] == 'jenis') || ($filter['tipe'] == 'anggaran') || ($filter['tipe'] == 'kelengkapan') ) ? 'hide' : '') :'')}} div-wrap">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12 jenis {{isset($filter['tipe']) ? ( $filter['tipe'] == 'jenis' ? '':'hide'): 'hide'}} div-wrap" >
              <label for="tipe" class="control-label">Jenis Media</label>
              <select class="form-control select2" name="jenis">
                <option value="MEDIA_CETAK_KORAN" {{isset($filter)? (isset($filter['jenis']) ? ($filter['jenis'] == 'MEDIA_CETAK_KORAN' ? 'selected=selected' : '') :''):''}} >Koran</option>
                <option value="MEDIA_CETAK_LUARRUANG"  {{isset($filter)? (isset($filter['jenis']) ? ($filter['jenis'] == 'MEDIA_CETAK_LUARRUANG' ? 'selected=selected' : '') :''):''}} >Media Luar Ruang</option>
              </select>
          </div>
