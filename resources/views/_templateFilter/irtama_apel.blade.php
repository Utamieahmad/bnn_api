      ...
      <div class="col-md-6 col-sm-6 col-xs-12">
        ...
        <?php
          $key = [
            ...
            'jml_hadir' => 'Jumlah Hadir',
            'jml_tdk_hadir' => 'Jumlah Tidak Hadir',
            'status' => 'Status',
          ];
          $f = $filter;
        ...
        ?>
          ...
          <div class="col-md-6 col-sm-6 col-xs-12 keyword {{isset($filter) ? 'hide' : ''}} div-wrap">
          ...
          <div class="jml_hadir {{(isset($filter['tipe']) ? (($filter['tipe'] == 'jml_hadir') ? '' : 'hide') :'hide')}} div-wrap">
            <div class="col-md-6 col-sm-6 col-xs-12 m-t-10">
              <label for="tipe" class="control-label">Mulai</label>
              <input type='text' name="hadir_from" class="form-control" value="{{isset($filter) ? (isset($filter['hadir_from']) ? $filter['hadir_from'] : '') :''}}"/>
            </div>
            <div class="col-md-6 col-sm-6 col-xs-12 m-t-10">
              <label for="tipe" class="control-label">Sampai</label>
              <input type='text' name="hadir_to" class="form-control" value="{{isset($filter) ? (isset($filter['hadir_to'])?$filter['hadir_to']:'') :''}}"/>
            </div>

          </div>
          <div class="jml_tdk_hadir {{(isset($filter['tipe']) ? (($filter['tipe'] == 'jml_tdk_hadir') ? '' : 'hide') :'hide')}} div-wrap">
            <div class="col-md-6 col-sm-6 col-xs-12 m-t-10">
              <label for="tipe" class="control-label">Mulai</label>
              <input type='text' name="absen_from" class="form-control" value="{{isset($filter) ? (isset($filter['absen_from']) ? $filter['absen_from'] : '') :''}}"/>
            </div>
            <div class="col-md-6 col-sm-6 col-xs-12 m-t-10">
              <label for="tipe" class="control-label">Sampai</label>
              <input type='text' name="absen_to" class="form-control" value="{{isset($filter) ? (isset($filter['absen_to'])?$filter['absen_to']:'') :''}}"/>
            </div>
