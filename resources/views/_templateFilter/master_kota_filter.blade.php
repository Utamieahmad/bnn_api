        ...
        ?>
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <select class="form-control select2"  name="tipe" onchange="formFilter(this)">
              ...
              <option value="nama" {{(isset($filter['tipe']) ? (($filter['tipe'] == 'nama') ? 'selected=selected' : '') :'')}}>Nama Kota</option>
              <option value="propinsi" {{(isset($filter['tipe']) ? (($filter['tipe'] == 'propinsi') ? 'selected=selected' : '') :'')}}>Provinsi</option>
            </select>
          </div>
