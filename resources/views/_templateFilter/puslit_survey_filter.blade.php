    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-6 col-xs-12">
        ...
        ?>
          ...
          <div class="col-md-6 col-sm-6 col-xs-12 keyword {{( isset($filter['tipe']) ?  ( ($filter['tipe'] == 'judul')  ? '' : 'hide')  :'' )}} div-wrap">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12 kelompok {{(isset($filter['tipe']) ? (($filter['tipe'] == 'kelompok') ? '' : 'hide') :'hide')}} div-wrap">
            <label for="tipe" class="control-label"> Kelompok Survey</label>
                ...
                @if(isset($kelompok_survey))
                  @if(count($kelompok_survey) > 0)
                    @foreach($kelompok_survey as $kkey => $kval)
                      <option value="{{$kkey}}" {{ ( isset($filter['kelompok']) ? (($filter['kelompok'] == $kkey ) ? 'selected=selected' : '') : '')}}> {{$kval}} </option>
                    @endforeach
                  @endif
                @endif
            </select>
    ...
    <div class="m-b-20">
      ...
      @if(isset($filter))
        ...
        @if( isset($s['tipe']))
          ...
          @elseif($s['tipe'] == 'judul')
            {{ $filter['judul'] }} ,
          @elseif($s['tipe'] == 'kelompok')
            {{ isset($kelompok_survey[$filter['kelompok']]) ? $kelompok_survey[$filter['kelompok']] :$filter['kelompok']  }} ,
         @endif
        @endif
