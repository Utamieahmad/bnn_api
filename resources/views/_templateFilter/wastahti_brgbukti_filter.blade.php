      ...
      <div class="col-md-6 col-sm-6 col-xs-12">
        ...
        <?php
          $key = [
            ...
            'periode' => 'Tanggal Pemusnahan',
            'nomor_tap' => 'Nomor Ketetapan',
            // 'BrgBukti' => 'Barang bukti Dimusnahkan',
            'status' => 'Status',
          ];
        ...
        ?>
          ...
          <div class="col-md-6 col-sm-6 col-xs-12 keyword {{(isset($filter['tipe']) ? ((($filter['tipe'] == 'nomor_lkn' ) || ($filter['tipe'] == 'nama_penyidik') || ($filter['tipe'] == 'nomor_tap') )  ? '' : 'hide') :'')}} div-wrap">
      ...
      @endphp
        ...
        @if( isset($s['tipe']))
          ...
          @elseif($s['tipe'] == 'BrgBukti')
            {{  ( isset($nm_brgbukti[$s['nm_brgbukti']])  ? $nm_brgbukti[$s['nm_brgbukti']] .', ' :  $s['nm_brgbukti'] .', ') }}
