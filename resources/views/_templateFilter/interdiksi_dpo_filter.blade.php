    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-6 col-xs-12">
        ...
        ?>
          ...
          <div class="col-md-6 col-sm-6 col-xs-12 keyword {{(isset($filter['tipe']) ? ((($filter['tipe'] == 'tersangka' ) || ($filter['tipe'] == 'no_lap') )  ? '' : 'hide') :'')}} div-wrap">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12 status_kelengkapan {{(isset($filter['tipe']) ? ((($filter['tipe'] == 'status_kelengkapan' )  )  ? '' : 'hide') :'hide')}} div-wrap">
              <label for="tipe" class="control-label">Tipe</label>

              <select class="form-control select2"  name="status_kelengkapan">
                ...
                @foreach($brgbukti as $j => $jvalue)
                  ...
                  @if(count($jvalue))
                    @foreach($jvalue as $jkey => $jname)
                      <option value="{{$jkey}}" {{isset($filter) ? (isset($filter['BrgBukti'])? ( ($filter['BrgBukti'] == $jkey) ? 'selected=selected' : ''):'') :''}}> &nbsp;&nbsp;&nbsp; {{$jname}}</option>
                    @endforeach
                  @endif
                @endforeach
              @endif
