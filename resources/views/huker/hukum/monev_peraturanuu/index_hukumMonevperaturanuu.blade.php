...
@section('title', 'Dir Hukum : Data Kegiatan Monev Peraturan Perundang-undangan')
		...
		<div class="m-t-40">
			...
			<div class="row">
				...
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="x_panel">
						<div class="x_title">
							<h2>Data Kegiatan Monev Peraturan Perundang-undangan<small></small></h2>
							...
							<li class="">
							<a href="{{url('huker/dir_hukum/add_hukum_monevperaturanuu')}}" class="btn btn-lg btn-round btn-primary">
						...
						<div class="x_content ">
							@if(count($data_monevperaturanuu))
								...
								<tbody>
									@php $i = 1; @endphp
									@foreach($data_monevperaturanuu as $d)
										<tr>
											<td> {{$i}}</td>
											...
											<td>
												<a href="{{url('huker/dir_hukum/edit_hukum_monevperaturanuu/'.$d['id'])}}"><i class="fa fa-pencil"></i></a>
