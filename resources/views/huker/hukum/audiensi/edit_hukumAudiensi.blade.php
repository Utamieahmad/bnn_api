...
@section('title', 'Ubah Data Kegiatan Konsultasi Hukum (Audiensi)')
...
@section('content')
    <div class="right_col" role="main">
        ...
        <div class="row">
            ...
            <div class="x_panel">
                <div class="x_title">
                    <h2>Form Ubah Data Kegiatan Konsultasi Hukum (Audiensi) Direktorat Hukum</h2>
                    <div class="clearfix"></div>
                </div>
    <div class="x_content">
                    <br />
                    ...
                    @endif
    <form action="{{URL('/huker/dir_hukum/update_hukum_audiensi')}}" class="form-horizontal" id="frm_add" method="post" enctype="multipart/form-data" autocomplete="on">
        ...
        <div class="form-group">
            <label for="no_sprint_kepala" class="col-md-3 col-sm-3 col-xs-12 control-label">No.Surat Perintah BNN</label>
            <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div data-repeater-item class="mt-repeater-item">
                            <div class="row mt-repeater-row">
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    ...
                                    <input name="meta_peserta[{{$r1}}][list_nama_instansi]" value="{{ (isset($c1['list_nama_instansi']) ? $c1['list_nama_instansi'] : '')}}" type="text" class="form-control"> </div>
                                <div class="col-md-5 col-sm-5 col-xs-12">
                                    <label class="control-label">Jumlah Peserta</label>
                                    <input name="meta_peserta[{{$r1}}][list_jumlah_peserta]" value="{{ (isset($c1['list_jumlah_peserta']) ? $c1['list_jumlah_peserta'] : '')}}" type="text" class="form-control numeric" onkeydown="numeric(event)"> </div>
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <select name="lokasi_kegiatan_idkabkota" id="lokasi_kegiatan_idkabkota" class="select2 form-control" placeholder="Pilih Kabupaten/Kota" tabindex="-1" aria-hidden="true">
                    ...
                    <optgroup label="{{$keyGroup}}">
                      ...
                      <option value="{{$key}}" {{($key == $data_detail['lokasi_kegiatan_idkabkota']) ? 'selected="selected"':""}} >{{$val}}</option>
                      @endforeach
                    </optgroup>
                    @endforeach
                </select>
        ...
        <div class="form-group">
            ...
            <div class="col-md-5">
                ...
                <span class="help-block" style="color:white">
                    ...
                    lihat file : <a style="color:yellow" href="{{\Storage::url('HukumAudiensi/'.$data_detail['hasil_dicapai'])}}">{{$data_detail['hasil_dicapai']}}</a>
                    @endif
                </span>
            </div>
        </div>
     ...
     <div class="form-actions fluid">
        <div class="row">
            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
				...
				<a href="{{route('hukum_audiensi')}}" class="btn btn-primary" type="button">BATAL</a>
            </div>
        </div>
    </div>
    </form>
