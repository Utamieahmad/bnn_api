...
@section('title', 'Tambah Data Kegiatan Konsultasi Hukum (Audiensi)')
...
@section('content')
    <div class="right_col" role="main">
        ...
        <div class="row">
            ...
            <div class="x_panel">
                <div class="x_title">
                    <h2>Form Tambah Data Kegiatan Konsultasi Hukum (Audiensi) Direktorat Hukum</h2>
                    <div class="clearfix"></div>
                </div>
    <div class="x_content">
                    <br />
   <form action="{{URL('/huker/dir_hukum/input_hukum_audiensi')}}" class="form-horizontal" id="frm_add" method="post" enctype="multipart/form-data" autocomplete="on">
        ...
        <div class="form-group" >
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <select name="pelaksana" id="pelaksana" class="form-control select2 selectPelaksana" tabindex="-1" aria-hidden="true" required >
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <input value="" id="no_sprint_kepala" name="no_sprint_kepala" type="text" class="form-control">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <input value="" id="no_sprint_deputi" name="no_sprint_deputi" type="text" class="form-control">
            </div>
        </div>
