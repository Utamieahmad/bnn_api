...
@section('title', 'Dir Hukum : Ubah Data Kegiatan Sosialisasi Peraturan Perundang-undangan')
...
@section('content')
    <div class="right_col" role="main">
        ...
        <div class="row">
            ...
            <div class="x_panel">
                <div class="x_title">
                    <h2>Form Ubah Data Kegiatan Sosialisasi Peraturan Perundang-undangan Direktorat Hukum</h2>
                    <div class="clearfix"></div>
                </div>
    <div class="x_content">
                    <br />
                    ...
                    @endif
    <form action="{{URL('/huker/dir_hukum/update_hukum_peraturanuu')}}" class="form-horizontal" id="frm_add" method="post" enctype="multipart/form-data" autocomplete="on">
        ...
        <div class="form-group">
            ...
            <div class="col-md-5">
               ...
               <span class="help-block" style="color:white">
                    ...
                    lihat file : <a style="color:yellow" href="{{\Storage::url('HukumPeraturanPerundangundangan/'.$data_detail['data']['file_upload'])}}">{{$data_detail['data']['file_upload']}}</a>
                    @endif
                </span>
            </div>
        </div>
