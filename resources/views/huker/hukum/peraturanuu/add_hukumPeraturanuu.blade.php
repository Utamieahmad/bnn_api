...
@section('title', 'Dir Hukum : Tambah Data Kegiatan Sosialisasi Peraturan Perundang-undangan')
...
@section('content')
    <div class="right_col" role="main">
        ...
        <div class="row">
            ...
            <div class="x_panel">
                <div class="x_title">
                    <h2>Form Tambah Data Kegiatan Sosialisasi Peraturan Perundang-undangan Direktorat Hukum</h2>
                    <div class="clearfix"></div>
                </div>
    <div class="x_content">
                    <br />
    <form action="{{URL('/huker/dir_hukum/input_hukum_peraturanuu')}}" class="form-horizontal" id="frm_add" method="post" enctype="multipart/form-data" autocomplete="on">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <select name="lokasi_kegiatan_idkabkota" id="lokasi_kegiatan_idkabkota" class="select2 form-control" placeholder="Pilih Kabupaten/Kota" aria-hidden="true">
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                <button type="submit" class="btn btn-success">KIRIM</button>
								<a href="{{route('hukum_peraturanuu')}}" class="btn btn-primary" type="button">BATAL</a>
            </div>
        </div>
    </div>
</form>
