...
@section('title', 'Dir Kerjasama : Ubah Data Kegiatan Sosialisasi')
...
@section('content')
    <div class="right_col" role="main">
        ...
        <div class="row">
            ...
            <div class="x_panel">
                <div class="x_title">
                    <h2>Form Ubah Data Kegiatan Sosialisasi Peraturan Perundang-undangan Direktorat Kerjasama</h2>
                    <div class="clearfix"></div>
                </div>
    <div class="x_content">
                    <br />
    <form action="{{URL('/huker/dir_kerjasama/update_kerjasama_sosialisasi')}}" class="form-horizontal" id="frm_add" method="post" enctype="multipart/form-data" autocomplete="on">
    ...
    <div class="form-body">
        ...
        <div class="form-group">
            <label for="materi" class="col-md-3 col-sm-3 col-xs-12 control-label">Materi Sosialisasi</label>
            <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div data-repeater-item class="mt-repeater-item">
                            <div class="row mt-repeater-row">
                                <div class="col-md-3">
                                    ...
                                    <input name="meta_instansi[{{$r1}}][list_nama_instansi]" value="{{$c1['list_nama_instansi']}}" type="text" class="form-control"> </div>
                                <div class="col-md-3">
                                    <label class="control-label">Alamat Instansi</label>
                                    <input name="meta_instansi[{{$r1}}][list_alamat_instansi]" value="{{$c1['list_alamat_instansi']}}" type="text" class="form-control"> </div>
                                <div class="col-md-3">
                                    <label class="control-label">Jumlah Peserta</label>
                                    <input name="meta_instansi[{{$r1}}][list_jumlah_peserta]" value="{{$c1['list_jumlah_peserta']}}" type="text" class="form-control numeric" onkeydown="numeric(event)"> </div>
                                <div class="col-md-1">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <div class="mt-radio-list">
                  <label class="mt-radio col-md-9"> <input disabled type="radio" {{($data_detail['data']['kodesumberanggaran'] == 'DIPA') ? 'checked="checked"':""}} value="DIPA" name="kodesumberanggaran" id="anggaran1">
                  <span>Dipa</span>
                  </label>
                  <label class="mt-radio col-md-9"> <input disabled type="radio" {{($data_detail['data']['kodesumberanggaran'] == 'NONDIPA') ? 'checked="checked"':""}} value="NONDIPA" name="kodesumberanggaran" id="anggaran2">
                  <span>Non Dipa</span>
                  </label>
                </div>
            </div>
            ...
            <div class="col-md-5">
                ...
                <span class="help-block" style="color:white">
                    @if (!empty($data_detail['data']['file_upload']))
                        lihat file : <a style="color:yellow" href="{{\Storage::url('KerjasamaSosialisasi/'.$data_detail['data']['file_upload'])}}">{{$data_detail['data']['file_upload']}}</a>
                    @endif
                </span>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                <button type="submit" class="btn btn-success">KIRIM</button>
								<a href="{{route('kerjasama_sosialisasi')}}" class="btn btn-primary" type="button">BATAL</a>
            </div>
        </div>
    </div>
</form>
