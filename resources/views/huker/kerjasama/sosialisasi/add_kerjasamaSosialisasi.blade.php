...
@section('title', 'Dir Kerjasama : Tambah Data Kegiatan Sosialisasi')
...
@section('content')
    <div class="right_col" role="main">
        ...
        <div class="row">
            ...
            <div class="x_panel">
                <div class="x_title">
                    <h2>Form Tambah Data Kegiatan Sosialisasi Peraturan Perundang-undangan Direktorat Kerjasama</h2>
                    <div class="clearfix"></div>
                </div>
    <div class="x_content">
                    <br />
    <form action="{{URL('/huker/dir_kerjasama/input_kerjasama_sosialisasi')}}" class="form-horizontal" id="frm_add" method="post" enctype="multipart/form-data" autocomplete="on">
