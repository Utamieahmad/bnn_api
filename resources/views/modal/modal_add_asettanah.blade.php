<!-- Modal -->
<div class="modal fade" id="add_modalAsettanah" role="dialog"
...
<div class="modal-dialog">
  <div class="modal-content modal-color">
    ...
    <h4 class="modal-title c-white" id="myModalLabel">
      Form Tambah Aset Tanah
    </h4>
  </div>
  <!-- Modal Body -->
  <div class="modal-body">

    <form class="form-horizontal" method="POST" id="form_modalAsettanah" action="{{URL('/pemberantasan/input_brgbukti_aset')}}" role="form">
      {{csrf_field()}}
      <input type="hidden" name="id" value="{{$id}}">
      <input type="hidden" name="url" value="{{\Request::path()}}">
      <input type="hidden" name="kode_isaset" value="ASET">
      <input type="hidden" name="kode_jenisaset" value="ASET_TANAH">
