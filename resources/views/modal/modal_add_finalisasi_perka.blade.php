...
<div class="modal fade" id="finalisasi_perka" role="dialog"
...
<div class="modal-dialog">
  <div class="modal-content modal-color">
    ...
    <h4 class="modal-title c-white" id="myModalLabel">
      Form Tambah Finalisasi Perka Dir Hukum
    </h4>
  </div>
  <!-- Modal Body -->
            ...
            <div class="fileinput fileinput-new" data-provides="fileinput">
              <div class="input-group input-large">
                ...
                <span class="help-block" style="color:white; display:none;" id="laporan">
                    lihat file : <a style="color:yellow" href="{{\Storage::url('HukumPerkaFinalisasi/')}}"></a>
                </span>
            </div>
          </div>
