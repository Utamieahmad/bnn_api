<!-- Modal -->
<div class="modal fade" id="modal_master_mediasosial" role="dialog"
...
<div class="modal-dialog">
  <div class="modal-content modal-color">
    ...
    <h4 class="modal-title c-white" id="myModalLabel">
      Form Input Media Sosial
    </h4>
  </div>
  <!-- Modal Body -->
  <div class="modal-body">

    <form class="form-horizontal" id="form_modalMediasosial" action="{{URL('/master/save_mediasosial')}}" method="post" role="form">
      {{csrf_field()}}
      ...
      <div class="form-group">
        <label  class="control-label col-md-3" >Kode Media Sosial</label>
        <div class="col-sm-9">
      ...
      <div class="form-group">
        <label  class="control-label col-md-3" >Nama Media Sosial</label>
        <div class="col-sm-9">
