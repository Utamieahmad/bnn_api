...
<div class="modal-dialog">
  ...
  <div class="modal-body">
    ...
    <form class="form-horizontal" action="{{URL('/user_management/reset_email')}}" method="post" role="form">
      {{csrf_field()}}
      <input type="hidden" name="id" id="id" value="{{$id}}"/>
      <div class="form-group">
        <label  class="control-label col-md-3" for="new_email">Email Baru</label>
        <div class="col-sm-9">
