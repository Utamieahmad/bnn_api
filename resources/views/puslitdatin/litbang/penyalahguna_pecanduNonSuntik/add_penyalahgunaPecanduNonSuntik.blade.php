...
@section('title', 'Tambah Data Penyalahguna Narkoba Pecandu Non Suntik')
    ...
    <div class="right_col" role="main">
    	...
    	<div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
            	<div class="x_panel">
	                <div class="x_title">
	                    <h2>Form Tambah Penyalahguna Narkoba Pecandu Non Suntik</h2>
	                    <div class="clearfix"></div>
	                </div>
	    			<div class="x_content">
	                <br/>
					...
					@endif
	           			<form action="{{URL('/puslitdatin/bidang_litbang/save_penyalahguna_pecandu_non_suntik')}}" class="form-horizontal" id="frm_add" method="post" enctype="multipart/form-data" autocomplete="on">
	           				{{ csrf_field()}}
		    				<div class="form-body">
		    					...
		    					<div class="form-group">
					             	...
					             	<div class='col-md-6 col-sm-6 col-xs-12 input-control'>
					             		<input type='text' name="prevalensi" value="" class="form-control" onKeydown="precentage_decimal(event,this)"/>
					              	</div>
					          	</div>
