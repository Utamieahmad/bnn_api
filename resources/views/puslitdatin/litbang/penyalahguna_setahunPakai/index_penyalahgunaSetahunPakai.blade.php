...
@section('title', 'Puslitdatin : Penyalahguna Narkoba Setahun Pakai')
		...
		<div class="m-t-40">
			...
			<div class="row">
				...
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="x_panel">
						<div class="x_title">
							<h2>Penyalahguna Narkoba Setahun Pakai<small></small></h2>
							...
							<li class="">
							<a href="{{url('puslitdatin/bidang_litbang/add_penyalahguna_setahun_pakai')}}" class="btn btn-lg btn-round btn-primary">
							<i class="fa fa-plus-circle c-yelow"></i> Tambah Data
							</a>
							</li>
							<li class="">
								@if(count($data) && isset($current_page))
									<a href="{{URL('/puslitdatin/bidang_litbang/print_page/penyalahguna_setahun_pakai/'.$current_page)}}" class="btn btn-lg btn-round btn-dark">
							...
							@if(count($data))
								...
								@foreach($data as $d)
									<tr> 
										...
										<td>{{$d->prevalensi}}</td>
										<td>
											<a href="{{url('puslitdatin/bidang_litbang/edit_penyalahguna_setahun_pakai/'.$d->id)}}"><i class="fa fa-pencil"></i></a>
