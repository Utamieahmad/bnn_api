...
@section('title', 'Ubah Penyalahguna Narkoba Pecandu Suntik')
    ...
    <div class="right_col" role="main">
    	...
    	<div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
            	<div class="x_panel">
	                <div class="x_title">
	                    <h2>Form Ubah Penyalahguna Narkoba Pecandu Suntik</h2>
	                    <div class="clearfix"></div>
	                </div>
	    			<div class="x_content">
	                <br/>
					...
					@endif
	           			<form action="{{URL('/puslitdatin/bidang_litbang/update_penyalahguna_pecandu_suntik')}}" class="form-horizontal" id="frm_add" method="post" enctype="multipart/form-data" autocomplete="on">
	           				{{ csrf_field()}}
					          	...
					          	<div class="form-actions fluid">
							        <div class="row">
							            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
							                ...
							                <a href="{{url('puslitdatin/bidang_litbang/penyalahguna_pecandu_suntik')}}" class="btn btn-primary" type="button">BATAL</a>
							            </div>
							        </div>
							    </div>
