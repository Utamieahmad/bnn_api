...
@section('title', 'Puslitdatin : Ubah Penyalahguna Narkoba Teratur Pakai')
    ...
    <div class="right_col" role="main">
    	...
    	<div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
            	<div class="x_panel">
	                <div class="x_title">
	                    <h2>Form Edit Penyalahguna Narkoba Teratur Pakai</h2>
	                    <div class="clearfix"></div>
	                </div>
	    			<div class="x_content">
	                <br/>
					...
					@endif
	           			<form action="{{URL('/puslitdatin/bidang_litbang/update_penyalahguna_teratur_pakai')}}" class="form-horizontal" id="frm_add" method="post" enctype="multipart/form-data" autocomplete="on">
	           				{{ csrf_field()}}
