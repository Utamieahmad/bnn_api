...
@section('title', 'Ubah Data Kegiatan Media Online')
...
<div class="right_col" role="main">
  ...
  <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        <div class="x_title">
          <h2>Form Ubah Data Kegiatan Media Online Direktorat Diseminasi</h2>
          <div class="clearfix"></div>
        </div>
        <div class="x_content">
          <br />
          ...
          @endif
          <form action="{{url('/pencegahan/dir_diseminasi/update_pendataan_online')}}" class="form-horizontal" id="frm_add" method="post" enctype="multipart/form-data" autocomplete="on">
            {{ csrf_field() }}
            ...
            <div class="form-body">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6">
                  <select name="idpelaksana" id="idpelaksana" required class="form-control select2 selectPelaksana" tabindex="-1" aria-hidden="true">
              ...
              <div class="form-group">
                <label for="materi" class="col-md-3 control-label">Konten</label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <textarea id="materi" name="materi" class="form-control" placeholder="Isi Konten">{{$pendataan['materi']}}</textarea>
                </div>
              </div>

              <div class="form-group">
                <label for="meta_media" class="col-md-3 control-label">Jenis Media Online</label>
                <div class="col-md-4">
                  @foreach($media['data'] as $md)
                    <label class="mt-radio col-md-12 col-sm-12 col-xs-12">
                      <input type="radio" {{($pendataan['jenis_media'] == $md['value_media']) ? "checked" : ""}} value="{{$md['value_media']}}" data-id="{{$md['id']}}" data-nama="{{$md['nama_media']}}" name="jenis_media" required>
              ...
              @if(json_decode($pendataan['meta_media']) != null)
                <div class="form-group" id="jenisMediaOnline">
                  ...
                  <div class="col-md-4 col-sm-4 col-xs-12">
                    @foreach($metamedia['data'] as $md)
                      <label class="mt-checkbox col-md-6 col-sm-6 col-xs-12">
                        <input type="checkbox" {{(in_array($md['value_media'], json_decode($pendataan['meta_media']))) ? "checked" : ""}} value="{{$md['value_media']}}" name="meta_media[]">
                        <span>{{$md['nama_media']}}</span>
                      </label>
                    @endforeach
                  </div>
              ...
              <div class="form-group">
                <label for="jumlah_yang_melihat" class="col-md-3 control-label">Jumlah Orang/Sebaran</label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input value="{{$pendataan['jumlah_yang_melihat']}}" id="jumlah_yang_melihat" name="jumlah_yang_melihat" type="text" class="form-control numeric" onkeydown="numeric(event)">
                </div>
              </div>
              <div class="form-group">
                <label for="orang_yang_tertarik" class="col-md-3 control-label">Orang Yang Tertarik</label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input value="{{$pendataan['orang_yang_tertarik']}}" id="orang_yang_tertarik" name="orang_yang_tertarik" type="text" class="form-control numeric" onkeydown="numeric(event)">
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                      <input type="text" name="lokasi" value="{{$pendataan['lokasi']}}" class="form-control col-md-7 col-xs-12">
                  </div>
              </div>
              <div class="form-group">
              ...
              <!-- <div class="form-group hide">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <textarea id="laporan" name="laporan" class="form-control">{{$pendataan['laporan']}}</textarea>
                </div>
              </div> -->
                  ...
                  <div class="fileinput fileinput-new" data-provides="fileinput">
                    <div class="input-group input-large">
                      ...
                      <span class="input-group-addon btn default btn-file">
                        ...
                        <input type="file" name="file_upload" value="{{$pendataan['file_upload']}}"> </span>
                        <a href="javascript:;" class="input-group-addon btn red fileinput-exists" data-dismiss="fileinput"> Hapus </a>
                      </div>
                    </div>
                    <span class="help-block" style="color:white">
                        @if (!empty($pendataan['file_upload']))
                            lihat file : <a style="color:yellow" href="{{\Storage::url('DiseminfoMediaonline/'.$pendataan['file_upload'])}}">{{$pendataan['file_upload']}}</a>
                        @endif
                    </span>
                  </div>
                </div>
