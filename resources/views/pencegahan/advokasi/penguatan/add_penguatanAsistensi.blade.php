...
@section('title', 'Tambah Data Kegiatan Penguatan Asistensi')
...
@section('content')
    <div class="right_col" role="main">
        ...
        <div class="row">
            ...
            <div class="x_panel">
                <div class="x_title">
                    <h2>Form Tambah Data Kegiatan Penguatan Asistensi Direktorat Advokasi</h2>
                    <div class="clearfix"></div>
                </div>
        <div class="x_content">
                    <br />
            <form action="{{URL('/pencegahan/dir_advokasi/input_penguatan_asistensi')}}" class="form-horizontal" id="frm_add" method="post" enctype="multipart/form-data" autocomplete="on">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <div class="mt-radio-list">
                    <label class="mt-radio col-md-9"> <input type="radio" value="Bang_Wawan" name="jenis_kegiatan">
                        <span>Bang Wawan</span>
                    </label>

                    <label class="mt-radio col-md-9"> <input type="radio" value="Penguatan" name="jenis_kegiatan">
                    <span>Penguatan</span>
                    </label>
                </div>
            </div>
												...
												<div data-repeater-item="" class="mt-repeater-item">
														<div class="row mt-repeater-row">
																...
																<!--div class="col-md-5">
																		...
																		<input name="group-c[0][list_alamat_instansi]" type="text" class="form-control"> </div-->
																<div class="col-md-3">
