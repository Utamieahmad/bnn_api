...
@section('title', 'Ubah Data Kegiatan Asistensi')
...
@section('content')
	<div class="right_col" role="main">
		...
		<div class="row">
			...
			<div class="x_panel">
				<div class="x_title">
					<h2>Form Ubah Data Kegiatan Asistensi Direktorat Advokasi</h2>
					<div class="clearfix"></div>
				</div>
		<div class="x_content">
					<br />
					 @if(session('status'))
						...
						@endif
			<form action="{{URL('/pencegahan/dir_advokasi/update_pendataan_asistensi')}}" class="form-horizontal" id="frm_add" method="post" enctype="multipart/form-data" autocomplete="on">
    {{-- <input type="hidden" name="form_method" value="create"> --}}
        ...
        <div class="form-group">
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
                <div class="mt-radio-list">
                    <label class="mt-radio col-md-9 col-sm-9 col-xs-12"> <input type="radio" {{($data_detail['data']['jenis_kegiatan'] == 'Bang_Wawan') ? 'checked="checked"':""}} value="Bang_Wawan" name="jenis_kegiatan">
                        <span>Bang Wawan</span>
                    </label>

                    <label class="mt-radio col-md-9 col-sm-9 col-xs-12"> <input type="radio" {{($data_detail['data']['jenis_kegiatan'] == 'Penguatan') ? 'checked="checked"':""}} value="Penguatan" name="jenis_kegiatan">
                    <span>Penguatan</span>
                    </label>
                </div>
            </div>
		...
		<div class="form-group">
			...
			<div class="col-md-4 col-sm-4 col-xs-12">
				<div class="mt-radio-list">
					<label class="mt-radio col-md-9 col-sm-9 col-xs-12"> <input type="radio" {{($data_detail['data']['kodesasaran'] == 'INSTITUSI_PEMERINTAH') ? 'checked="checked"':""}} value="INSTITUSI_PEMERINTAH" name="sasaran">
					<span>Institusi Pemerintah</span>
					</label>

					<label class="mt-radio col-md-9 col-sm-9 col-xs-12"> <input type="radio" {{($data_detail['data']['kodesasaran'] == 'INSTITUSI_SWASTA') ? 'checked="checked"':""}} value="INSTITUSI_SWASTA" name="sasaran">
					<span>Institusi Swasta</span>
					</label>

					<label class="mt-radio col-md-9 col-sm-9 col-xs-12"> <input type="radio" {{($data_detail['data']['kodesasaran'] == 'LINGKUNGAN_PENDIDIKAN') ? 'checked="checked"':""}} value="LINGKUNGAN_PENDIDIKAN" name="sasaran">
					<span>Lingkungan Pendidikan</span>
					</label>

					<label class="mt-radio col-md-9 col-sm-9 col-xs-12"> <input type="radio" {{($data_detail['data']['kodesasaran'] == 'LINGKUNGAN_MASYARAKAT') ? 'checked="checked"':""}} value="LINGKUNGAN_MASYARAKAT" name="sasaran">
		...
		<div class="form-group">
			...
			<div class="col-md-4 col-sm-4 col-xs-12">
				<div class="mt-radio-list">
					<label class="mt-radio col-md-9 col-sm-9 col-xs-12"> <input {{($data_detail['data']['kodesumberanggaran'] == 'DIPA') ? 'checked="checked"':""}} type="radio" value="DIPA" name="kodesumberanggaran" id="anggaran1">
					<span>Dipa</span>
					</label>
					<label class="mt-radio col-md-9 col-sm-9 col-xs-12"> <input {{($data_detail['data']['kodesumberanggaran'] == 'NONDIPA') ? 'checked="checked"':""}} type="radio" value="NONDIPA" name="kodesumberanggaran" id="anggaran2">
					<span>Non Dipa</span>
					</label>
				</div>
			</div>
			...
			<div class="col-md-5 col-sm-5 col-xs-12">
				...
				<span class="help-block" style="color:white">
					@if (!empty($data_detail['data']['file_upload']))
						lihat file : <a style="color:yellow" href="{{\Storage::url('AdvokasiAsistensi/'.$data_detail['data']['file_upload'])}}">{{$data_detail['data']['file_upload']}}</a>
					@endif
				</span>
			</div>
		</div>
