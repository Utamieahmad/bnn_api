...
@section('title', 'Tambah Data Kegiatan KIE')
...
@section('content')
	<div class="right_col" role="main">
		...
		<div class="row">
			...
			<div class="x_panel">
				<div class="x_title">
					<h2>Form Tambah Data Kegiatan KIE Direktorat Advokasi</h2>
					<div class="clearfix"></div>
				</div>
		<div class="x_content">
					<br />
			<form action="{{URL('/pencegahan/dir_advokasi/input_pendataan_sosialisasi')}}" class="form-horizontal" id="frm_add" method="post" enctype="multipart/form-data" autocomplete="on">
