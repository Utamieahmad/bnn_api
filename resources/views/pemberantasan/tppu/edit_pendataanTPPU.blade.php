...
@section('title','Ubah Pendataan TPPU')
@section('content')
<div class="right_col" role="main">
	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				<div class="x_title">
					<h2>Form Ubah Pendataan TPPU Direktorat TPPU</h2>
					<!-- <?php
					// echo '<pre>';
					// print_r($data_kasus);
					// echo '</pre>';
				...
				<div class="x_content">
		            ...
		            @endif
					<form  data-parsley-validate class="form-horizontal form-label-left" action="{{URL('/pemberantasan/dir_tppu/update_pendataan_tppu')}}" enctype="multipart/form-data" method="post" >
						{{ csrf_field() }}
						...
						<div class="form-group">
							...
							<div class='col-md-6 col-sm-6 col-xs-12 input-group date tanggal'>
								...
								<input type='text' name="tanggalLKN" value="{{ \Carbon\Carbon::parse($data_kasus['data']['kasus_tanggal'] )->format('d/m/Y') }}" class="form-control" />
								@else
								<input type="text" name="tanggalLKN" value="" class="form-control" />
								@endif
											...
											<div class="col-md-6">
													...
													<span class="help-block" style="color:white">
															@if ($data_kasus['data']['file_upload'])
																	@if (\Storage::exists('TppuKasus/'.$data_kasus['data']['file_upload']))
																			Lihat File : <a  target="_blank" class="link_file" href="{{\Storage::url('TppuKasus/'.$data_kasus['data']['file_upload'])}}">{{$data_kasus['data']['file_upload']}}</a>
																	@endif
															@endif
							...
							<div class="x_content">
								...
								<div class="" role="tabpanel" data-example-id="togglable-tabs">
									<ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
										...
										<li role="presentation" class="hide"><a href="#barang_bukti_narkotika" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">Barang Bukti Narkotika</a>
										</li>
										<li role="presentation" class="hide"><a href="#barang_bukti_prekursor" role="tab" id="profile-tab2" data-toggle="tab" aria-expanded="false">Barang Bukti Prekursor</a>
										</li>
										...
										<li role="presentation" class="hide"><a href="#barang_bukti_nonnarkotika" role="tab" id="profile-tab2" data-toggle="tab" aria-expanded="false">Barang Bukti Non Narkotika</a>
										</li>
									...
									<div id="myTabContent" class="tab-content">
										...
										<div role="tabpanel" class="tab-pane fade hide" id="barang_bukti_narkotika" aria-labelledby="profile-tab">
											<div class="tools pull-right" style="margin-bottom:15px;">
												...
												<tbody>
													...
													<tr>
														...
														<td class="actionTable">
															...
															<a class="button-delete deleteBbNarkotika" data-url="kasusbrgbukti" data-target="{{$brgBukti['kasus_barang_bukti_id']}}" data-api="kasusbrgbukti" style="cursor:pointer"><i class="fa fa-trash f-18"></i></a>
														</td>
													</tr>
													@php $i = $i+1; @endphp
													@endforeach
										...
										<div role="tabpanel" class="tab-pane fade hide" id="barang_bukti_prekursor" aria-labelledby="profile-tab">
											<div class="tools pull-right" style="margin-bottom:15px;">
											...
											<table class="table table-striped table-bordered table-hover table-checkable" id="grid_tersangka">
												...
												<tr>
													...
													<td class="actionTable">
														...
														<a class="button-delete deleteBbPrekursor" data-url="buktiprekursor" data-target="{{$brgBukti['barangbukti_nonnarkotika_id']}}" data-api="buktiprekursor" style="cursor:pointer"><i class="fa fa-trash f-18"></i></a>
													</td>
												</tr>
												@php $i = $i+1; @endphp
												@endforeach
										...
										<div role="tabpanel" class="tab-pane fade hide" id="barang_bukti_nonnarkotika" aria-labelledby="profile-tab">
											<div class="tools pull-right" style="margin-bottom:15px;">
												...
												<tbody>
													...
													<tr>
														...
														<td class="actionTable">
															...
															<a class="button-delete deleteBbNonnarkotika" data-url="kasusbrgbukti" data-target="{{$brgBukti['kasus_barang_bukti_id']}}" data-api="kasusbrgbukti" style="cursor:pointer"><i class="fa fa-trash f-18"></i></a>
														</td>
													</tr>
													@php $i = $i+1; @endphp
													@endforeach
		...
		<div class="modal fade bs-modal-sm" tabindex="-1" role="dialog" id="modalDelete" aria-hidden="true">
		        ...
		        <input type="hidden" class="target_parent_id" value=""/>
						<input type="hidden" class="audit_menu" value="Pemberantasan - Direktorat TPPU - Pendataan LKN"/>
