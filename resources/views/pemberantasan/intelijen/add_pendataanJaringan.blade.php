...
<div class="right_col" role="main">
	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			...
			<div class="x_panel">
				<div class="x_title">
					<h2>Form Tambah Pendataan Jaringan Narkoba yang sudah Diungkap Direktorat Intelijen</h2>
					<div class="clearfix"></div>
				</div>
				<div class="x_content">
					<br />
					<form action="{{URL('/pemberantasan/dir_intelijen/add_data_pendataan_jaringan')}}" method="post" data-parsley-validate class="form-horizontal form-label-left">
						{{ csrf_field() }}
						...
						<div class="form-group">
							<div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
								...
								<a href="{{URL('/pemberantasan/dir_intelijen/pendataan_jaringan')}}" class="btn btn-primary" type="button">Batal</a>
							</div>
						</div>
