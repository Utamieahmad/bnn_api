			...
			<div class="x_panel">
				...
				<div class="x_content">
					...
					@if (session('status'))
			            ...
			            @endif
					<form action="{{url('/pemberantasan/dir_wastahti/input_pendataan_brgbukti')}}" enctype="multipart/form-data" method="post" class="form-horizontal form-label-left">
						{{ csrf_field() }}
