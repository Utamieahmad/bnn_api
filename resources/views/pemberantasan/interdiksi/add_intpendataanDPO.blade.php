...
@section('content')
	...
	<div class="right_col" role="main">
		...
		<div class="row">
			...
			<div class="x_panel">
				<div class="x_title">
					<h2>Form Tambah Pendataan LKN Direktorat Interdiksi</h2>
					<div class="clearfix"></div>
				</div>
				<div class="x_content">
					<br />
					<form  data-parsley-validate class="form-horizontal form-label-left" action="{{URL('/pemberantasan/dir_interdiksi/input_pendataan_intdpo')}}" enctype="multipart/form-data" method="post">
					{{ csrf_field() }}
