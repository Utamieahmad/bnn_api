...
<div class="right_col" role="main">
	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				<div class="x_title">
					<h2>Form Ubah Pendataan LKN Direktorat Psikotropika</h2>
					<div class="clearfix"></div>
				</div>
				<div class="x_content">
					<br />
					<form  data-parsley-validate class="form-horizontal form-label-left" action="{{URL('/pemberantasan/dir_psikotropika/update_psi_pendataan_lkn')}}" enctype="multipart/form-data" method="post" >
						{{ csrf_field() }}
						...
						<div class="form-group">
							...
							<div class='col-md-6 col-sm-6 col-xs-12 input-group date tanggal'>
								...
								@else
								<input type="text" name="tanggalKejadian" value="" class="form-control" />
								@endif
								<span class="input-group-addon">
									<span class="glyphicon glyphicon-calendar"></span>
								</span>
								...
								<div class="form-group">
											...
											<div class="col-md-6">
													...
													<span class="help-block" style="color:white">
															@if ($data_kasus['data']['file_upload'])
																	@if (\Storage::exists('PsikotropikaKasus/'.$data_kasus['data']['file_upload']))
																			Lihat File : <a  target="_blank" class="link_file" href="{{\Storage::url('PsikotropikaKasus/'.$data_kasus['data']['file_upload'])}}">{{$data_kasus['data']['file_upload']}}</a>
																	@endif
															@endif
									...
									<div class="form-group">
										<div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
											...
											<a href="{{route('psi_pendataan_lkn')}}" class="btn btn-primary" type="button">BATAL</a>
										</div>
									</div>
