...
@section('title', 'Dir PLRIP : Ubah Penilaian Lembaga Rehabilitasi ')
    ...
    <div class="right_col" role="main">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Form Ubah Penilaian Lembaga Rehabilitasi PLRIP</h2>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <br />
                        ...
                        <form action="{{route('update_penilaian_lembaga_plrip')}}" class="form-horizontal" id="frm_add" method="post"  autocomplete="on">
                            <div class="form-body">
                                {{csrf_field()}}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input value="{{$data->nama}}" id="nama" name="nama" type="text" class="form-control" required>
                                    </div>
                                </div>
