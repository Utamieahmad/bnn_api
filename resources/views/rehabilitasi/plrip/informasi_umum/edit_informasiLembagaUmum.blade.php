...
@section('title', 'Ubah Data Informasi Lembaga Umum PLRIP')
		...
		<div class="row">
			...
			<div class="x_panel">
				...
				<div class="x_content">
					...
					@endif
					<form  method="POST" action="{{route('update_informasi_lembaga_umum_plrip')}}" data-parsley-validate class="form-horizontal form-label-left text-left">
						{{csrf_field()}}
						...
						<ul class="order-abjad">
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="text" name="legalitas_lembaga_nama_notaris" value="{{$data->legalitas_lembaga_nama_notaris}}"  class="form-control col-md-7 col-xs-12">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="text" name="legalitas_lembaga_noakta_notaris" value="{{$data->legalitas_lembaga_noakta_notaris}}"  class="form-control col-md-7 col-xs-12">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="text" name="legalitas_no_ijin_operasional" value="{{$data->legalitas_no_ijin_operasional}}"  class="form-control col-md-7 col-xs-12">
								</div>
							</div>
							<ul class="order-dash">
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input type="text" name="legalitas_lembaga_pemberi_ijin" value="{{$data->legalitas_lembaga_pemberi_ijin}}"  class="form-control col-md-7 col-xs-12">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input type="text" name="legalitas_lembaga_wilayah_ijin" value="{{$data->legalitas_lembaga_wilayah_ijin}}"  class="form-control col-md-7 col-xs-12">
									</div>
								</div>
								...
								<!--<div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input type="text" name="legalitas_lembaga_wilayah_ijin_kodepos" value="{{$data->legalitas_lembaga_wilayah_ijin_kodepos}}"  class="form-control col-md-7 col-xs-12" onKeydown="numeric_only(event,this)">
									</div>
								</div>-->
								...
								<div class="form-group">
	              					...
	              					<div class='col-md-6 col-sm-6 col-xs-12 date input-group all_date'>
										<input type='text' name="tgl_legalitas_masa_berlaku" value="{{ (isset($data->tgl_legalitas_masa_berlaku) ? \Carbon\Carbon::parse($data->tgl_legalitas_masa_berlaku)->format('d/m/Y') : '')}}" class="form-control" />
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="text" name="legalitas_lembaga_npwp" value="{{$data->legalitas_lembaga_npwp}}"  class="form-control col-md-7 col-xs-12">
								</div>
							</div>
						</ul>
						<div class="form-group">
						...
						<ul class="order-abjad">
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="text" class="form-control col-md-7 col-xs-12 numeric" name="sdm_manajemen" value="{{$data->sdm_manajemen}}" onKeydown="numeric_only(event,this)">
								</div>
								<div class="col-md-3 col-sm-3 col-xs-12">
									Orang
								</div>
							...
							<ul class="order-dash">
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input type="text" name="sdm_dokter_umum" value="{{$data->sdm_dokter_umum}}"  class="form-control col-md-7 col-xs-12 numeric" onKeydown="numeric_only(event,this)">
									</div>
									<div class="col-md-3 col-sm-3 col-xs-12">
										Orang
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input type="text" name="sdm_spesialis_jiwa" value="{{$data->sdm_spesialis_jiwa}}"  class="form-control col-md-7 col-xs-12 numeric" onKeydown="numeric_only(event,this)">
									</div>
									<div class="col-md-3 col-sm-3 col-xs-12">
										Orang
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input type="text" name="sdm_dokter_gigi" value="{{$data->sdm_dokter_gigi}}" class="form-control col-md-7 col-xs-12 numeric" onKeydown="numeric_only(event,this)">
									</div>
									<div class="col-md-3 col-sm-3 col-xs-12">
										Orang
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input type="text" name="sdm_spesialis_lain" class="form-control col-md-7 col-xs-12 numeric" value="{{$data->sdm_spesialis_lain}}" onKeydown="numeric_only(event,this)">
									</div>
									<div class="col-md-3 col-sm-3 col-xs-12">
										Orang
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input type="text" name="sdm_psikolog" value="{{$data->sdm_psikolog}}"  class="form-control col-md-7 col-xs-12 numeric" onKeydown="numeric_only(event,this)">
									</div>
									<div class="col-md-3 col-sm-3 col-xs-12">
										Orang
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input type="text" name="sdm_perawat" value="{{$data->sdm_perawat}}"  class="form-control col-md-7 col-xs-12 numeric" onKeydown="numeric_only(event,this)">
									</div>
									<div class="col-md-3 col-sm-3 col-xs-12">
										Orang
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input type="text" name="sdm_apoteker" value="{{$data->sdm_apoteker}}"  class="form-control col-md-7 col-xs-12 numeric" onKeydown="numeric_only(event,this)">
									</div>
									<div class="col-md-3 col-sm-3 col-xs-12">
										Orang
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input type="text" name="sdm_analis" value="{{$data->sdm_analis}}"  class="form-control col-md-7 col-xs-12 numeric" onKeydown="numeric_only(event,this)">
									</div>
									<div class="col-md-3 col-sm-3 col-xs-12">
										Orang
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input type="text" name="sdm_peksos" value="{{$data->sdm_peksos}}"  class="form-control col-md-7 col-xs-12 numeric" onKeydown="numeric_only(event,this)">
									</div>
									<div class="col-md-3 col-sm-3 col-xs-12">
										Orang
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input type="text" name="sdm_konselor"  value="{{$data->sdm_konselor}}"   class="form-control col-md-7 col-xs-12 numeric" onKeydown="numeric_only(event,this)">
									</div>
									<div class="col-md-3 col-sm-3 col-xs-12">
										Orang
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input type="text" name="sdm_spsi" value="{{$data->sdm_spsi}}"  class="form-control col-md-7 col-xs-12 numeric" onKeydown="numeric_only(event,this)">
									</div>
									<div class="col-md-3 col-sm-3 col-xs-12">
										Orang
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input type="text" name="sdm_skm" value="{{$data->sdm_skm}}"  class="form-control col-md-7 col-xs-12 numeric" onKeydown="numeric_only(event,this)">
									</div>
									<div class="col-md-3 col-sm-3 col-xs-12">
										Orang
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input type="text" name="sdm_sag" value="{{$data->sdm_sag}}"  class="form-control col-md-7 col-xs-12 numeric" onKeydown="numeric_only(event,this)">
									</div>
									<div class="col-md-3 col-sm-3 col-xs-12">
										Orang
									</div>
							...
							<ul class="order-dash">
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input type="text" name="sdm_penunjang_administrasi" value="{{$data->sdm_penunjang_administrasi}}"  class="form-control col-md-7 col-xs-12 numeric" onKeydown="numeric_only(event,this)">
									</div>
									<div class="col-md-3 col-sm-3 col-xs-12">
										Orang
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input type="text" name="sdm_penunjang_logistik" value="{{$data->sdm_penunjang_logistik}}"  class="form-control col-md-7 col-xs-12 numeric" onKeydown="numeric_only(event,this)">
									</div>
									<div class="col-md-3 col-sm-3 col-xs-12">
										Orang
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input type="text" name="sdm_penunjang_keamanan" value="{{$data->sdm_penunjang_keamanan}}"  class="form-control col-md-7 col-xs-12 numeric" onKeydown="numeric_only(event,this)">
									</div>
									<div class="col-md-3 col-sm-3 col-xs-12">
										Orang
									</div>
