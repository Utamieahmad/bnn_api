...
@section('title', 'Tambah Data Informasi Lebaga Umum')
@section('content')
	<div class="right_col" role="main">
		...
		<div class="row">
			...
			<div class="x_panel">
				<div class="x_title">
					<h2>Form Ubah Informasi Umum Lembaga Direktorat PLRIP</h2>
				...
				<div class="x_content">
					...
					@endif
					<form  method="POST" action="{{route('save_informasi_lembaga_umum_plrip')}}" data-parsley-validate class="form-horizontal form-label-left text-left">
						{{csrf_field()}}
						...
						<ul class="order-abjad">
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="text" name="legalitas_lembaga_nama_notaris" value=""  class="form-control col-md-7 col-xs-12">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="text" name="legalitas_lembaga_noakta_notaris" value=""  class="form-control col-md-7 col-xs-12">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="text" name="legalitas_no_ijin_operasional" value=""  class="form-control col-md-7 col-xs-12">
								</div>
							</div>
							<ul class="order-dash">
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input type="text" name="legalitas_lembaga_pemberi_ijin" value=""  class="form-control col-md-7 col-xs-12">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input type="text" name="legalitas_lembaga_wilayah_ijin" value=""  class="form-control col-md-7 col-xs-12">
									</div>
								</div>

								
								<div class="form-group">
	              					<label for="tgl_pelaksanaan" class="col-md-3 col-sm-3 col-xs-12 control-label"><li><i class="fa fa-minus"></i>Masa Berlaku Ijin</li></label>
	              					<div class='col-md-6 col-sm-6 col-xs-12 input-group date all_date'>
										<input type='text' name="tgl_legalitas_masa_berlaku" value="" class="form-control" />
							...
							<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12" ><li>  No. NPWP (a.n) </li></label>
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="text" name="legalitas_lembaga_npwp" value=""  class="form-control col-md-7 col-xs-12">
								</div>
							</div>
						</ul>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" name="alamat_kodepos" value=""  class="form-control col-md-7 col-xs-12 " onKeydown="numeric_only(event,this)">
							</div>
						</div>
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<div class="checkbox">
										...
										<input type="text"  name="layanan_pendekatan_lain" value="" class="form-control layanan_pendekatan_lain hide"/>
									</div>
								</div>
							</div>
							<div class="form-group">
						...
						<ul class="order-abjad">
							...
							<ul class="order-dash">
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input type="text" class="form-control col-md-7 col-xs-12" name="sdm_dokter_umum" value="" onKeydown="numeric_only(event,this)">
									</div>
									<div class="col-md-3 col-sm-3 col-xs-12">
										Orang
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input type="text" class="form-control col-md-7 col-xs-12" name="sdm_spesialis_jiwa" value="" onKeydown="numeric_only(event,this)">
									</div>
									<div class="col-md-3 col-sm-3 col-xs-12">
										Orang
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input type="text" name="sdm_spesialis_lain" class="form-control col-md-7 col-xs-12 numeric" value="" onKeydown="numeric_only(event,this)">
									</div>
									<div class="col-md-3 col-sm-3 col-xs-12">
										Orang
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input type="text" name="sdm_psikolog" value=""  class="form-control col-md-7 col-xs-12 numeric" onKeydown="numeric_only(event,this)">
									</div>
									<div class="col-md-3 col-sm-3 col-xs-12">
										Orang
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input type="text" name="sdm_perawat" value=""  class="form-control col-md-7 col-xs-12 numeric" onKeydown="numeric_only(event,this)">
									</div>
									<div class="col-md-3 col-sm-3 col-xs-12">
										Orang
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input type="text" name="sdm_apoteker" value=""  class="form-control col-md-7 col-xs-12 numeric" onKeydown="numeric_only(event,this)">
									</div>
									<div class="col-md-3 col-sm-3 col-xs-12">
										Orang
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input type="text" name="sdm_analis" value="" class="form-control col-md-7 col-xs-12 numeric" onKeydown="numeric_only(event)">
									</div>
									<div class="col-md-3 col-sm-3 col-xs-12">
										Orang
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input type="text" name="sdm_peksos" value="" class="form-control col-md-7 col-xs-12 numeric" onKeydown="numeric_only(event,this)">
									</div>
									<div class="col-md-3 col-sm-3 col-xs-12">
										Orang
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input type="text" name="sdm_konselor" value=""  class="form-control col-md-7 col-xs-12 numeric" onKeydown="numeric_only(event,this)">
									</div>
									<div class="col-md-3 col-sm-3 col-xs-12">
										Orang
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input type="text" name="sdm_spsi" value=""  class="form-control col-md-7 col-xs-12 numeric" onKeydown="numeric_only(event,this)">
									</div>
									<div class="col-md-3 col-sm-3 col-xs-12">
										Orang
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input type="text" name="sdm_skm" value="" class="form-control col-md-7 col-xs-12 numeric" onKeydown="numeric_only(event,this)">
									</div>
									<div class="col-md-3 col-sm-3 col-xs-12">
										Orang
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input type="text" name="sdm_sag" value=""  class="form-control col-md-7 col-xs-12 numeric" onKeydown="numeric_only(event,this)">
									</div>
									<div class="col-md-3 col-sm-3 col-xs-12">
										Orang
									</div>
							...
							<ul class="order-dash">
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input type="text" name="sdm_penunjang_administrasi" value=""  class="form-control col-md-7 col-xs-12 numeric" onKeydown="numeric_only(event,this)">
									</div>
									<div class="col-md-3 col-sm-3 col-xs-12">
										Orang
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input type="text" name="sdm_penunjang_logistik" value=""  class="form-control col-md-7 col-xs-12 numeric" onKeydown="numeric_only(event,this)">
									</div>
									<div class="col-md-3 col-sm-3 col-xs-12">
										Orang
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input type="text" name="sdm_penunjang_keamanan" value=""  class="form-control col-md-7 col-xs-12 numeric" onKeydown="numeric_only(event,this)">
									</div>
									<div class="col-md-3 col-sm-3 col-xs-12">
										Orang
									</div>
						...
						<ul class="order-dash">
							<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12"><li> Rawat Inap </li></label>
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="text" name="kapasitas_inap" value="" class="form-control col-md-7 col-xs-12 numeric" onKeydown="numeric_only(event,this)">
								</div>
								<div class="col-md-3 col-sm-3 col-xs-12">
							...
							<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12"> <li> Rawat Jalan </li></label>
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="text" class="form-control col-md-7 col-xs-12 numeric" name="kapasitas_jalan" value="" onKeydown="numeric_only(event,this)">
								</div>
								<div class="col-md-3 col-sm-3 col-xs-12">
									Orang/Periode Pelayanan
								</div>
						...
						<ul class="order-dash">
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="text" name="pelatihan_assessment" value=""  class="form-control col-md-7 col-xs-12 numeric" onKeydown="numeric_only(event,this)">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="text" name="pelatihan_adiksi" value=""  class="form-control col-md-7 col-xs-12 numeric" onKeydown="numeric_only(event,this)">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="text" name="pelatihan_intervensi" value="" class="form-control col-md-7 col-xs-12 numeric" onKeydown="numeric_only(event,this)">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="text" name="pelatihan_fisiologi"  value="" class="form-control col-md-7 col-xs-12 numeric" onKeydown="numeric_only(event,this)">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="text" name="pelatihan_tatalaksana" value=""  class="form-control col-md-7 col-xs-12 numeric" onKeydown="numeric_only(event,this)">
								</div>
							</div>
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										...
										<div class="col-md-6 col-sm-6 col-xs-12">
											...
											<input type="text" name="pelatihan_lainnya_jumlah" value="" class="form-control col-md-3 col-xs-12 numeric" onKeydown="numeric_only(event,this)">
										</div>
									</div>
									</div>
								</div>
						...
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
                    			...
                    			<a href="{{route('informasi_lembaga_umum_plrip')}}" class="btn btn-primary" type="button">BATAL</a>
							</div>
						</div>
					</form>
				</ul>
