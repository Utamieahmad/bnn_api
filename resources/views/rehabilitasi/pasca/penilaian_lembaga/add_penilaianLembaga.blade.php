...
@section('title', 'Dir PascaRehabilitasi : Tambah Penialian Lembaga')
                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        @if(session('status'))
                         ...
                         @endif
                        <form action="{{route('save_penilaian_lembaga_pascarehabilitasi')}}" class="form-horizontal" id="frm_add" method="post"  autocomplete="on">
                            <div class="form-body">
                                {{csrf_field()}}
