		...
		<div class="row">
			...
			<div class="x_panel">
				...
				<div class="x_content">
					...
					@endif
					<form  method="POST" action="{{route('save_informasi_lembaga_umum_pascarehabilitasi')}}" data-parsley-validate class="form-horizontal form-label-left text-left">
						{{csrf_field()}}
								...
								<div class="radio">
									@if(count($sumberbiaya)>=1)
										@foreach($sumberbiaya as $skey=> $svalue)
											<label class="mt-radio col-md-9"> <input type="radio" value="{{$skey}}" name="kode_sumberbiaya">
						                    <span>{{$svalue}}</span>
						                    </label>
						                @endforeach
					                @endif
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										...
										<div class="col-md-6 col-sm-6 col-xs-12">
											...
											<input type="text" name="pelatihan_lainnya_jumlah" value=""  class="form-control col-md-3 col-xs-12" onKeydown="numeric_only(event,this)">
										</div>
									</div>
									</div>
								</div>
						...
						<ul class="order-dash">
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="text" name="jml_pasca_reg" value=""  class="form-control col-md-7 col-xs-12" onclick="numeric_only(event,this)">
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12"><li><i class="fa fa-minus"></i>Pasca Intensif</li></label>
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="text" name="jml_pasca_int" value=""  class="form-control col-md-7 col-xs-12" onclick="numeric_only(event,this)">
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12"><li><i class="fa fa-minus"></i>Pasca Lanjut</li></label>
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="text" name="jml_pasca_lnj" value=""  class="form-control col-md-7 col-xs-12" onclick="numeric_only(event,this)">
								</div>
							</div>
						</ul>
						<div class="form-group">
