        ...
        <div class="clearfix"></div>
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Form Ubah Dokumen NSPK Direktorat Pascarehabilitasi</h2>
                            <div class="clearfix"></div>
                        </div>
                        <div class="x_content">
                            <br />
                            @if(session('status'))
                              ...
                              @endif 
                            <form action="{{route('update_dokumen_nspk_pascarehabilitasi')}}" class="form-horizontal" id="form-multipart" method="post" enctype="multipart/form-data" autocomplete="on">
