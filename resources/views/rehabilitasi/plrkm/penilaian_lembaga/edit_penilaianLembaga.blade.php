...
@section('title', 'Dir PLRKM : Edit Penilaian Lembaga PLRKM')
    ...
    <div class="right_col" role="main">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Form Ubah Penilaian Lembaga Rehabilitasi Direktorat PLRKM</h2>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <br />
                        @if(session('status'))
                         ...
                         @endif
                        <form action="{{route('update_penilaian_lembaga_plrkm')}}" class="form-horizontal" id="frm_add" method="post"  autocomplete="on">
                            <div class="form-body">
                                {{csrf_field()}}
