...
@section('title', 'Dir PLRKM : Tambah Penilaian Lembaga PLRKM')
    ...
    <div class="right_col" role="main">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Form Tambah Penilaian Lembaga PLRKM Direktorat PLRKM</h2>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <br />
                        @if(session('status'))
                         ...
                         @endif
                        <form action="{{route('save_penilaian_lembaga_plrkm')}}" class="form-horizontal" id="frm_add" method="post"  autocomplete="on">
                            <div class="form-body">
                                {{csrf_field()}}
                                <div class="form-group">
                                    <label for="nama" class="col-md-3 col-sm-3 col-xs-12 control-label">Nama Lembaga</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input value="" id="nama" name="nama" type="text" class="form-control">
                                    </div>
                                </div>
                            ...
                            <div class="form-actions fluid">
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3  col-sm-offset-3  col-xs-offset-3">
                                        ...
                                        <a href="{{route('penilaian_lembaga_plrkm')}}" class="btn btn-primary" type="button">BATAL</a>
