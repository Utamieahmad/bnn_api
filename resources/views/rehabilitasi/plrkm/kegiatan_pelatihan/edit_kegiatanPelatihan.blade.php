    ...
    <div class="right_col" role="main">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Form Ubah Kegiatan Direktorat PLRKM</h2>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <br />
                        @if(session('status'))
                         ...
                         @endif
                        <form action="{{route('update_kegiatan_pelatihan_plrkm')}}" class="form-horizontal" id="frm_add" method="post" enctype="multipart/form-data" autocomplete="on">
                             ...
                             <div class="form-actions fluid">
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                        ...
                                        <a href="{{route('kegiatan_pelatihan_plrkm')}}" class="btn btn-primary" type="button">BATAL</a>
                                    </div>
                                </div>
                            </div>
                        </form>
                        @include('rehabilitasi.plrkm.kegiatan_pelatihan.index_pesertaPelatihan')
                    </div>
                </div>
            </div>
        </div>
