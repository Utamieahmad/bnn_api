    ...
    <div class="right_col" role="main">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Form Tambah Dokumen NSPK Direktorat PLRKM</h2>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <br />
                        <form action="{{route('save_dokumen_nspk_plrkm')}}" class="form-horizontal" id="frm_add" method="post" enctype="multipart/form-data" autocomplete="on">
                            {{csrf_field()}}
                            <div class="form-body">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <span class="help-block" style="color:white">
                                            @if (isset($data->file_nspk))
                                                Lihat File : <a  target="_blank"  style="color:yellow" href="{{url($file_path.$data->file_nspk)}}">{{$data->file_nspk}}</a>
                                            @endif
                                        </span>
                                    </div>
                                </div>
                             ...
                             <div class="form-actions fluid">
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                        ...
                                        <a href="{{route('dokumen_nspk_pascarehabilitasi')}}" class="btn btn-primary" type="button">BATAL</a>
                                    </div>
                                </div>
                            </div>
                        </form>
