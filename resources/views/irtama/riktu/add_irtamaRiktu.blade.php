...
@section('title', 'Tambah Data Audit dengan Tujuan Tertentu')
...
@section('content')
  ...
  <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        <div class="x_title">
          <h2>Form Tambah Data Audit dengan Tujuan Tertentu Inspektorat Utama</h2>
          <div class="clearfix"></div>
        </div>
        <div class="x_content">
          <br />
          <form action="{{url('/irtama/riktu/input_irtama_riktu')}}" class="form-horizontal" id="frm_add" method="post" enctype="multipart/form-data" autocomplete="on">
            {{ csrf_field() }}
            <div class="form-body">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input value="" id="no_hasil_laporan" name="no_hasil_laporan" type="text" class="form-control" required>
                </div>
              </div>
              ...
              <div class="form-group">
                  ...
                  <div class='col-md-6 col-sm-6 col-xs-12 input-group date datepicker-only'>
                      ...
                      <input type='text' value="" name="tgl_hasil_laporan" class="form-control" />
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input value="" id="judul_hasil_laporan" name="judul_hasil_laporan" type="text" class="form-control" required>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input value="" id="jenis_pelanggaran" name="jenis_pelanggaran" type="text" class="form-control" >
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input value="" id="jumlah_terperiksa" name="jumlah_terperiksa" type="number" class="form-control">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input value="" id="jumlah_saksi" name="jumlah_saksi" type="number" class="form-control" >
                </div>
              </div>
                  ...
                  <div class="radio">
                    @if(count($barang_bukti))
                      @foreach($barang_bukti as $bkey=> $bvalue)
                        <label class="mt-radio col-md-12 col-sm-12 col-xs-12"> <input type="radio" value="{{$bkey}}" name="kodebarangbukti">
                          <span>{{$bvalue}}</span>
                        </label>
                      @endforeach
                    @endif
                ...
                <div class="col-md-5 col-sm-5 col-xs-12">
                  ...
                  @if(count($informasi))
                    @foreach($informasi as $ikey=> $ivalue)
                      <label class="mt-radio col-md-12 col-sm-12 col-xs-12"> <input type="radio" value="{{$ikey}}" name="kodesumberinformasi">
                        <span>{{$ivalue}}</span>
                      </label>
                    @endforeach
                  @endif
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input value="" id="kriteria_perka" name="kriteria_perka" type="text" class="form-control">
                </div>
              </div>
                  ...
                  <div class="radio">
                    @if(count($hasil_riktu))
                      @foreach ($hasil_riktu as $hkey => $hvalue)
                        <label class="mt-radio col-md-12 col-sm-12 col-xs-12"> <input type="radio" value="{{$hkey}}" name="terbukti">
                          <span>{{$hvalue}}</span>
                        </label>
                      @endforeach
                    @endif
