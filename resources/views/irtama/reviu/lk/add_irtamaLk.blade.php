...
@section('title', 'Tambah Data Reviu Laporan Keuangan')
  ...
  <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        ...
        <div class="x_content">
          <br />
          <form action="{{url('/irtama/reviu/input_irtama_lk')}}" class="form-horizontal" id="frm_add" method="post" enctype="multipart/form-data" autocomplete="on">
            {{ csrf_field() }}
            ...
            <div class="form-body">
              ...
              <div class="form-group">
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                  ...
                  <label class="mt-radio col-md-12 col-sm-12 col-xs-12"> <input type="radio" value="1" name="semester">
                    <span>1</span>
                  </label>

                  <label class="mt-radio col-md-12 col-sm-12 col-xs-12"> <input type="radio" value="2" name="semester">
                    <span>2</span>
                  </label>
              ...
              <div class="form-group">
                ...
                <div class='col-md-6 col-sm-6 col-xs-12 input-group date year-only'>
                  <input type='text' name="thn_anggaran" class="form-control" />
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input value="" id="uappa" name="uappa" type="text" class="form-control" >
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input value="" id="uappa_e1" name="uappa_e1" type="text" class="form-control" >
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input value="" id="uappa_w" name="uappa_w" type="text" class="form-control" >
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input value="" id="uakpa" name="uakpa" type="text" class="form-control" >
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input value="" id="lap_realisasi" name="lap_realisasi" type="text" class="form-control" >
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input value="" id="neraca" name="neraca" type="text" class="form-control" >
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input value="" id="lap_operasional" name="lap_operasional" type="text" class="form-control" >
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input value="" id="lap_perubahan" name="lap_perubahan" type="text" class="form-control" >
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input value="" id="catatan_lap" name="catatan_lap" type="text" class="form-control" >
                </div>
              </div>
