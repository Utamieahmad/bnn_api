            ...
            <section class="login_content">
                    <?php if(session('message')): ?>
                        <?php 
                         ...
                         ?>
                    <?php endif; ?>
                <form class="form-horizontal form-label-left input_mask" action="<?php echo e(action('AuthenticationController@login_process')); ?>" method="POST">
                    <p class="c-login">Masuk ke Akun Anda</p>
                    <?php echo e(csrf_field()); ?>

                    <div class="form-group has-feedback m-t-32">
                        <input type="text" class="form-control has-feedback-left input-login" placeholder="Email" name="email" value="<?php echo e(old('email')); ?>" />
                    ...
                    <div class="m-t-32">
                        ...
                        <a class="reset_pass" href="<?php echo e(url('forgot_password')); ?>" >Lupa Kata Sandi ?</a>
...
<?php echo $__env->make('layouts.base_layout', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>