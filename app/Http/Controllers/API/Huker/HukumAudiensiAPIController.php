...
use App\Models\Huker\HukumAudiensi;
use App\Http\Controllers\Controller;
use App\Transformers\Json;

class HukumAudiensiAPIController extends Controller
{
    /* @author : Daniel Andi */
    ...
    public function index(Request $request)
    {
        ...
        $kondisi = array();
        if ($request->tempat_kegiatan != '') {
            array_push($kondisi, array('tempat_kegiatan', 'ilike', '%'.$request->tempat_kegiatan.'%'));
        }
        ...
        if ($request->pelaksana != '') {
            array_push($kondisi, array('pelaksana', '=', $request->pelaksana));
        }

        $qresults = HukumAudiensi::where($kondisi);
    ...
    {
        try {
            $data = HukumAudiensi::where('id', $id)->first();
    ...
    public function store(Request $request)
    {
        try {
            ...
            $data = HukumAudiensi::create($request->except('api_token'));
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            $data = HukumAudiensi::findOrFail($id);
