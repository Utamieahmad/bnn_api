...
use App\Models\Irtama\ReviuRkbmn;
use App\Http\Controllers\Controller;
use App\Transformers\Json;

class ReviuRkbmnAPIController extends Controller
{
    /* @author : Daniel Andi */
    ...
    public function index(Request $request)
    {
        ...
        $qresults = ReviuRkbmn::where($kondisi);

        $total_results = $qresults->count();
        //$total_results = ReviuRkbmn::count();
        ...
        try {
            ...
            // $data = ReviuRkbmn::where('status', 1)->orderBy('id', 'desc')->offset($offset)->limit($limit)->get();;
            $paginate['page']       = $page;
    ...
    {
        try {
            $data = ReviuRkbmn::where('id', $id)->first();
            // $data = ReviuRkbmn::where([['status', 1], ['tersangka_id', $id]])->first();
    ...
    public function store(Request $request)
    {
        try {
            ...
            $data = ReviuRkbmn::create($request->except('api_token'));
