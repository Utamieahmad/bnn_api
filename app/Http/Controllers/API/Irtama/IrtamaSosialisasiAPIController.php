...
use App\Models\Irtama\IrtamaSosialisasi;
use App\Http\Controllers\Controller;
use App\Transformers\Json;

class IrtamaSosialisasiAPIController extends Controller
{
    /* @author : Daniel Andi */
    ...
    public function index(Request $request)
    {
        ...
        $qresults = IrtamaSosialisasi::where($kondisi);

        $total_results = $qresults->count();
        //$total_results = IrtamaSosialisasi::count();
        ...
        if($tipe && $order){
            if($tipe == 'sprin' || $tipe == 'periode'|| $tipe == 'jumlah_peserta'){
                if($tipe == 'periode'){
        ...
        try {
            ...
            // $data = IrtamaSosialisasi::where('status', 1)->orderBy('id', 'desc')->offset($offset)->limit($limit)->get();;
            $paginate['page']       = $page;
    ...
    {
        try {
            $data = IrtamaSosialisasi::where('id', $id)->first();
            // $data = IrtamaSosialisasi::where([['status', 1], ['tersangka_id', $id]])->first();
    ...
    public function store(Request $request)
    {
        try {
            ...
            $data = IrtamaSosialisasi::create($request->except('api_token'));
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            $data = IrtamaSosialisasi::findOrFail($id);
