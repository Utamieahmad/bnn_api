...
use App\Models\Cegah\DiseminfoMediaOnline;
use App\Models\Cegah\ViewDiseminfoMediaOnline;
use App\Http\Controllers\Controller;
use App\Transformers\Json;

class DiseminfoMediaOnlineAPIController extends Controller
{
    /* @author : Daniel Andi */
    ...
    public function index(Request $request)
    {
        ...
        // $total_results = ViewDiseminfoMediaOnline::where($kondisi)->count();
        $qresults = ViewDiseminfoMediaOnline::where($kondisi);
        ...
        try {
            ...
            // $data = DiseminfoMediaOnline::where('status', 1)->orderBy('id', 'desc')->offset($offset)->limit($limit)->get();;
            $paginate['page']       = $page;
    ...
    {
        try {
            $data = DiseminfoMediaOnline::where('id', $id)->first();
            // $data = DiseminfoMediaOnline::where([['status', 1], ['tersangka_id', $id]])->first();
    ...
    public function store(Request $request)
    {
        try {
            ...
            $data = DiseminfoMediaOnline::create($request->except('api_token'));
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            $data = DiseminfoMediaOnline::findOrFail($id);
