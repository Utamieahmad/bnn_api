...
use App\Models\Cegah\AdvokasiMonev;
use App\Models\Cegah\ViewAdvokasiMonev;
use App\Http\Controllers\Controller;
use App\Transformers\Json;

class AdvokasiMonevAPIController extends Controller
{
    /* @author : Daniel Andi */
    ...
    public function index(Request $request)
    {
        ...
        // $total_results = ViewAdvokasiMonev::where($kondisi)->count();
        $qresults = ViewAdvokasiMonev::where($kondisi);
        ...
        try {
            ...
            // $data = AdvokasiMonev::where('status', 1)->orderBy('id', 'desc')->offset($offset)->limit($limit)->get();;
            $paginate['page']       = $page;
    ...
    {
        try {
            $data = AdvokasiMonev::where('id', $id)->first();
    ...
    public function store(Request $request)
    {
        try {
            ...
            $data = AdvokasiMonev::create($request->except('api_token'));
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            $data = AdvokasiMonev::findOrFail($id);
