...
use App\Models\Cegah\AdvokasiBimtek;
use App\Models\Cegah\ViewAdvokasiBimtek;
use App\Http\Controllers\Controller;
use App\Transformers\Json;

class AdvokasiBimtekAPIController extends Controller
{
    /* @author : Daniel Andi */
    ...
    public function index(Request $request)
    {
        ...
        // $total_results = ViewAdvokasiBimtek::where($kondisi)->count();
        $qresults = ViewAdvokasiBimtek::where($kondisi);
        ...
        try {
            ...
            // $data = AdvokasiBimtek::where('status', 1)->orderBy('id', 'desc')->offset($offset)->limit($limit)->get();;
            $paginate['page']       = $page;
    ...
    {
        try {
            $data = AdvokasiBimtek::leftjoin('tr_wilayah', 'cegahadvokasi_bimtek.lokasi_kegiatan_idkabkota', '=', 'tr_wilayah.id_wilayah')->select('cegahadvokasi_bimtek.*', 'tr_wilayah.nm_wilayah AS lokasi_kegiatan_namakabkota')->where('id', $id)->first();
    ...
    public function store(Request $request)
    {
        try {
            ...
            $data = AdvokasiBimtek::create($request->except('api_token'));
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            $data = AdvokasiBimtek::findOrFail($id);
