...
use App\Models\Cegah\AdvokasiJejaring;
use App\Models\Cegah\ViewAdvokasiJejaring;
use App\Http\Controllers\Controller;
use App\Transformers\Json;

class AdvokasiJejaringAPIController extends Controller
{
    /* @author : Daniel Andi */
    ...
    public function index(Request $request)
    {
        ...
        //$total_results = ViewAdvokasiJejaring::where($kondisi)->count();
        $qresults = ViewAdvokasiJejaring::where($kondisi);
        ...
        try {
            ...
            // $data = AdvokasiJejaring::where('status', 1)->orderBy('id', 'desc')->offset($offset)->limit($limit)->get();;
            $paginate['page']       = $page;
    ...
    {
        try {
            $data = AdvokasiJejaring::leftjoin('tr_wilayah', 'cegahadvokasi_jejaring.lokasi_kegiatan_idkabkota', '=', 'tr_wilayah.id_wilayah')->select('cegahadvokasi_jejaring.*', 'tr_wilayah.nm_wilayah AS lokasi_kegiatan_namakabkota')->where('id', $id)->first();
    ...
    public function store(Request $request)
    {
        try {
            ...
            $data = AdvokasiJejaring::create($request->except('api_token'));
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            $data = AdvokasiJejaring::findOrFail($id);
