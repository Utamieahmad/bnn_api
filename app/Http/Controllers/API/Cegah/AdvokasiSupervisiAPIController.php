...
use App\Models\Cegah\AdvokasiSupervisi;
use App\Models\Cegah\ViewAdvokasiSupervisi;
use App\Http\Controllers\Controller;
use App\Transformers\Json;

class AdvokasiSupervisiAPIController extends Controller
{
    /* @author : Daniel Andi */
    ...
    public function index(Request $request)
    {
        ...
        // $total_results = ViewAdvokasiSupervisi::where($kondisi)->count();
        $qresults = ViewAdvokasiSupervisi::where($kondisi);
        ...
        try {
            ...
            // $data = AdvokasiSupervisi::where('status', 1)->orderBy('id', 'desc')->offset($offset)->limit($limit)->get();;
            $paginate['page']       = $page;
    ...
    {
        try {
            $data = AdvokasiSupervisi::leftjoin('tr_wilayah', 'cegahadvokasi_supervisi.lokasi_kegiatan_idkabkota', '=', 'tr_wilayah.id_wilayah')->select('cegahadvokasi_supervisi.*', 'tr_wilayah.nm_wilayah AS lokasi_kegiatan_namakabkota')->where('id', $id)->first();
            // $data = AdvokasiSupervisi::where([['status', 1], ['tersangka_id', $id]])->first();
    ...
    public function store(Request $request)
    {
        try {
            ...
            $data = AdvokasiSupervisi::create($request->except('api_token'));
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            $data = AdvokasiSupervisi::findOrFail($id);
