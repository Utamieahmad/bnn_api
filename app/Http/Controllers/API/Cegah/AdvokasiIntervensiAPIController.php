...
use App\Models\Cegah\AdvokasiIntervensi;
use App\Models\Cegah\ViewAdvokasiIntervensi;
use App\Http\Controllers\Controller;
use App\Transformers\Json;

class AdvokasiIntervensiAPIController extends Controller
{
    /* @author : Daniel Andi */
    ...
    public function index(Request $request)
    {
        ...
        // $total_results = ViewAdvokasiIntervensi::where($kondisi)->count();
        $qresults = ViewAdvokasiIntervensi::where($kondisi);
        ...
        try {
            ...
            // $data = AdvokasiIntervensi::where('status', 1)->orderBy('id', 'desc')->offset($offset)->limit($limit)->get();;
            $paginate['page']       = $page;
    ...
    {
        try {
            $data = AdvokasiIntervensi::where('id', $id)->first();
    ...
    public function store(Request $request)
    {
        try {
            ...
            $data = AdvokasiIntervensi::create($request->except('api_token'));
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            $data = AdvokasiIntervensi::findOrFail($id);
