...
use App\Models\Dayamas\PsmSupervisi;
use App\Models\Dayamas\ViewPsmSupervisi;
use App\Http\Controllers\Controller;
use App\Transformers\Json;

class PsmSupervisiAPIController extends Controller
{
    /* @author : Daniel Andi */

    public function index(Request $request)
    {
        // $total_results = ViewPsmSupervisi::count();
        $kondisi = array();
        $qresults = new ViewPsmSupervisi;
        ...
        try {
            ...
            // $data = PsmSupervisi::where('status', 1)->orderBy('id', 'desc')->offset($offset)->limit($limit)->get();;
            $paginate['page']       = $page;
    ...
    {
        try {
            $data = PsmSupervisi::where('id', $id)->first();
            // $data = PsmSupervisi::where([['status', 1], ['tersangka_id', $id]])->first();
    ...
    {
        try {
            $data = PsmSupervisi::create($request->except('api_token'));
    ...
    {
        try {
            $data = PsmSupervisi::findOrFail($id);
