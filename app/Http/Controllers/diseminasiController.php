...
class diseminasiController extends Controller
{
  ...
  public function inputpendataanPenyiaran(Request $request)
  {
      ...
      if($request->hasFile('foto1')){
          ...
          $extension = $request->file('foto1')->getClientOriginalExtension();
          $fileNameToStore= $filename.'_'.time().'.'.$extension;
          $path = $request->file('foto1')->storeAs('Diseminfo/Penyiaran', $fileNameToStore);
          $image = public_path('upload/Diseminfo/Penyiaran/'.$fileNameToStore);
          $data = file_get_contents($image);
          $image1 = base64_encode($data);
          Storage::delete('Diseminfo/Penyiaran/'.$fileNameToStore);
      }else{
        $image1 = null;
      }
      ...
      if($request->hasFile('foto2')){
          ...
          $extension = $request->file('foto2')->getClientOriginalExtension();
          $fileNameToStore= $filename.'_'.time().'.'.$extension;
          $path = $request->file('foto2')->storeAs('Diseminfo/Penyiaran', $fileNameToStore);
          $image = public_path('upload/Diseminfo/Penyiaran/'.$fileNameToStore);
          $data = file_get_contents($image);
          $image2 = base64_encode($data);
          Storage::delete('Diseminfo/Penyiaran/'.$fileNameToStore);
      ...
      if($request->hasFile('foto3')){
          ...
          $extension = $request->file('foto3')->getClientOriginalExtension();
          $fileNameToStore= $filename.'_'.time().'.'.$extension;
          $path = $request->file('foto3')->storeAs('Diseminfo/Penyiaran', $fileNameToStore);
          $image = public_path('upload/Diseminfo/Penyiaran/'.$fileNameToStore);
          $data = file_get_contents($image);
          $image3 = base64_encode($data);
          Storage::delete('Diseminfo/Penyiaran/'.$fileNameToStore);
